            ...
            <div class="col-md-4 col-12">
                <div class="card metric-card border-left-secondary h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-muted small d-block mb-0" style="font-size: 11px;">নিষ্ক্রিয়
                                    টেমপ্লেট</span>
                            ...
                            <div class="col-md-6">
                                <div class="form-group mb-3">
                                    ...
                                    <input type="text" name="name" class="form-control" required
                                        placeholder="যেমন: order_confirmation">
                                    <small class="text-muted">ইউনিক এবং স্পেস ছাড়া লিখুন ( snake_case ব্যবহার
                                        করুন)</small>
                                </div>
                            </div>
                            <div class="col-md-6">
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        if (response.success && response.html) {
                            ...
                            $('#templates-table-container').html(
                                '<div class="alert alert-warning m-3">কোন টেমপ্লেট পাওয়া যায়নি</div>'
                                );
                        }
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                error: function() {
                                    toastr.error(
                                        'স্ট্যাটাস পরিবর্তন করতে ব্যর্থ হয়েছে');
                                }
                            });
                        }
                    });
