            ...
            <div class="row g-2">
                <div class="col-md-6 col-sm-12">
                    <input type="text" id="search-input" class="form-control"
                        placeholder="শিরোনাম, স্ল্যাগ বা কনটেন্ট খুঁজুন..." autocomplete="off" value="{{ request('search') }}">
                </div>
                <div class="col-md-2 col-sm-4">
                    <select id="status-filter" class="form-select">
                        <option value="">সব স্ট্যাটাস</option>
                        <option value="active" {{ request('status') == 'active' ? 'selected' : '' }}>লাইভ (Live)</option>
                        <option value="inactive" {{ request('status') == 'inactive' ? 'selected' : '' }}>খসড়া (Draft)
                        </option>
                    </select>
                </div>
                <div class="col-md-2 col-sm-4">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger small mb-0"><i class="fas fa-exclamation-triangle"></i> এই কাজটি ফেরানো সম্ভব
                        নয়!</p>
                </div>
