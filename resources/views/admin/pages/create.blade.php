                        ...
                        <div class="card card-outline card-success shadow-sm mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-4">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" placeholder="যেমন: vision, about-us" value="{{ old('slug') }}" required>
                                    <div class="mt-2 slug-preview-box">
                                        <i class="fas fa-external-link-alt text-muted me-1"></i> পেজটির ইউআরএল হবে: 
                                        <span class="fw-bold text-success font-monospace" id="slugPreview">{{ url('/') }}/[slug]</span>
                                    </div>
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="wp-editor-wrap">
                                        ...
                                        <div class="wp-editor-container">
                                            <textarea name="content" id="editor" class="form-control @error('content') is-invalid @enderror" placeholder="পেজের সম্পূর্ণ কন্টেন্ট লিখুন..." style="height: 450px;">{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                    @error('content')
                        ...
                        <div class="card card-outline card-info shadow-sm mb-4">
                            ...
                            <div class="card-body">
                                <div class="mb-0">
                                    ...
                                    <textarea name="meta_description" id="meta_description" class="form-control" rows="4" placeholder="মেটা বর্ণনা লিখুন...">{{ old('meta_description') }}</textarea>
                        ...
                        <div class="card card-outline card-primary shadow-sm mb-4">
                            ...
                            <div class="card-body bg-white p-3">
                                <div class="google-preview-container" style="font-family: Arial, sans-serif; font-size: 14px; line-height: 1.4;">
                                    ...
                                    <div class="google-preview-url text-success" id="google-url" style="color: #006621; font-size: 13px; white-space: nowrap; overflow: hidden; text-overflow: ellipsis; margin-bottom: 2px;">{{ url('/') }}/[slug]</div>
...
$(document).ready(function() {
    const autosaveKey = 'page-create-autosave-content';
