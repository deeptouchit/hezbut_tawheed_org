        ...
        <div class="card-body p-2">
            <div class="row g-2">
                <div class="col-md-4 col-sm-6">
                    <input type="text" id="search-input" class="form-control" placeholder="নাম, ইংরেজি নাম বা পদবী..."
                        autocomplete="off" value="{{ request('search') }}">
                </div>
                <div class="col-md-3 col-sm-6">
                    <select id="category-filter" class="form-select">
                        <option value="">সব ক্যাটাগরি</option>
                        <option value="central" {{ request('category') == 'central' ? 'selected' : '' }}>কেন্দ্রীয় নেতৃত্ব
                        </option>
                        <option value="advisory" {{ request('category') == 'advisory' ? 'selected' : '' }}>উপদেষ্টা পরিষদ
                        </option>
                        <option value="executive" {{ request('category') == 'executive' ? 'selected' : '' }}>নির্বাহী কমিটি
                        </option>
                        <option value="regional" {{ request('category') == 'regional' ? 'selected' : '' }}>আঞ্চলিক নেতৃত্ব
                        </option>
                    </select>
                </div>
                <div class="col-md-3 col-sm-6">
                    <select id="per-page-filter" class="form-select">
                        ...
                        <option value="15"
                            {{ request('per_page') == 15 ? 'selected' : (request('per_page') == '' ? 'selected' : '') }}>
                            ১৫টি</option>
            ...
            <div class="col-md-2-4 col-sm-6 col-12">
                <div class="card metric-card border-left-success h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-muted small d-block mb-0" style="font-size: 11px;">কেন্দ্রীয়
                                    নেতৃত্ব</span>
            ...
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    <span class="badge bg-primary ms-2"
                        id="total-count">{{ $leaders->total() ?? $leaders->count() }}</span>
                </h3>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteModalLabel"><i class="fas fa-exclamation-triangle"></i> নিশ্চিত
                        করুন</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>আপনি কি নিশ্চিত যে আপনি "<strong><span id="delete-item-name"></span></strong>" এর নেতৃত্বের
                        প্রোফাইলটি ডিলিট করতে চান?</p>
                    <p class="text-danger small"><i class="fas fa-info-circle"></i> সতর্কবার্তা: এই অ্যাকশনটি আর ফিরিয়ে
                        নেওয়া যাবে না!</p>
                </div>
