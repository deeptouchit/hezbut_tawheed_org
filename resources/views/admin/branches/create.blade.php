...
@section('page-title', 'নতুন কার্যালয় যোগ করুন')
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h3 class="mb-0 fw-bold text-dark-green"><i class="fas fa-map-marked-alt me-1"></i> নতুন কার্যালয় যোগ করুন</h3>
            ...
            <div class="col-md-9">
                <div class="form-section shadow-sm bg-white border border-light">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="name" id="name" class="form-control @error('name') is-invalid @enderror" placeholder="যেমন: ঢাকা জেলা কার্যালয়" value="{{ old('name') }}" required>
                            @error('name')
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <select name="type" id="type" class="form-select @error('type') is-invalid @enderror" required>
                                ...
                                <option value="central" {{ old('type') === 'central' ? 'selected' : '' }}>কেন্দ্রীয় কার্যালয়</option>
                                <option value="division" {{ old('type') === 'division' ? 'selected' : '' }}>বিভাগীয় কার্যালয়</option>
                                <option value="district" {{ old('type') === 'district' ? 'selected' : '' }}>জেলা কার্যালয়</option>
                                <option value="upazila" {{ old('type') === 'upazila' ? 'selected' : '' }}>উপজেলা কার্যালয়</option>
                                <option value="international" {{ old('type') === 'international' ? 'selected' : '' }}>আন্তর্জাতিক শাখা</option>
                            </select>
                            @error('type')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="address" id="address" class="form-control @error('address') is-invalid @enderror" rows="3" placeholder="কার্যালয়ের বিস্তারিত ঠিকানা এখানে লিখুন..." required>{{ old('address') }}</textarea>
                        @error('address')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="phone" id="phone" class="form-control @error('phone') is-invalid @enderror" placeholder="যেমন: +৮৮০১xxxxxxxxx" value="{{ old('phone') }}">
                            @error('phone')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="email" name="email" id="email" class="form-control @error('email') is-invalid @enderror" placeholder="যেমন: dhaka@hezbuttawheed.org" value="{{ old('email') }}">
                            @error('email')
                                <div class="invalid-feedback">{{ $message }}</div>
                            @enderror
                        </div>
                ...
                <div class="form-section shadow-sm bg-white border border-light">
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="google_map_url" id="google_map_url" class="form-control @error('google_map_url') is-invalid @enderror" rows="3" placeholder="গুগল ম্যাপস থেকে শেয়ার লিংক বা embed map iframe এর src লিঙ্কটি এখানে দিন...">{{ old('google_map_url') }}</textarea>
            ...
            <div class="col-md-3">
                <div class="form-section shadow-sm bg-white border border-light">
                    ...
                    <div class="mb-4">
                        ...
                        <small class="text-muted"><i class="fas fa-info-circle"></i> ল্যান্ডস্কেপ বা সাধারণ অনুপাতের ছবি (JPEG, PNG, WEBP)।</small>
                        @error('image')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
