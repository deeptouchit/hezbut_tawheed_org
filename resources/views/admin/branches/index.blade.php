            ...
            <div class="row g-2">
                <div class="col-md-4 col-sm-6">
                    <input type="text" id="search-input" class="form-control"
                        placeholder="কার্যালয়ের নাম, ঠিকানা বা কর্মকর্তার নাম..." autocomplete="off"
                        value="{{ request('search') }}">
                </div>
                <div class="col-md-3 col-sm-6">
                    <select id="type-filter" class="form-select">
                        <option value="">সব কার্যালয়</option>
                        <option value="central" {{ request('type') == 'central' ? 'selected' : '' }}>কেন্দ্রীয় কার্যালয়
                        </option>
                        <option value="division" {{ request('type') == 'division' ? 'selected' : '' }}>বিভাগীয় কার্যালয়
                        </option>
                        <option value="district" {{ request('type') == 'district' ? 'selected' : '' }}>জেলা কার্যালয়
                        </option>
                        <option value="upazila" {{ request('type') == 'upazila' ? 'selected' : '' }}>উপজেলা কার্যালয়
                        </option>
                        <option value="international" {{ request('type') == 'international' ? 'selected' : '' }}>আন্তর্জাতিক
                            শাখা</option>
                    </select>
                </div>
                <div class="col-md-3 col-sm-6">
            ...
            <div class="col-md-2 col-sm-6 col-12">
                <div class="card metric-card border-left-danger h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-muted small d-block mb-0" style="font-size: 11px;">কেন্দ্রীয়
                                    কার্যালয়</span>
            ...
            <div class="col-md-2 col-sm-6 col-12">
                <div class="card metric-card border-left-primary h-100">
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                <span class="text-muted small d-block mb-0" style="font-size: 11px;">বিভাগীয়
                                    কার্যালয়</span>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger small mb-0"><i class="fas fa-exclamation-triangle"></i> এই কার্যালয় ডিলিট হলে আর
                        ফেরত আনা যাবে না!</p>
                </div>
