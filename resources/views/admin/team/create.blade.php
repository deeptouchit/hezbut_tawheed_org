...
@section('page-title', 'নতুন টিম মেম্বার যোগ করুন')
...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-user-plus me-2"></i> নতুন টিম মেম্বার যোগ করুন
            </h3>
        ...
        <div class="card-body">
            <form action="{{ route('admin.team.store') }}" method="POST" enctype="multipart/form-data" id="teamMemberForm">
                @csrf
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="bio" 
                                          ...
                                          rows="4"
                                          placeholder="টিম মেম্বারের সম্পর্কে সংক্ষিপ্ত বর্ণনা">{{ old('bio') }}</textarea>
                                @error('bio')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <select name="experience" class="form-control @error('experience') is-invalid @enderror">
                                        ...
                                        <option value="0-1" {{ old('experience') == '0-1' ? 'selected' : '' }}>০-১ বছর</option>
                                        <option value="1-2" {{ old('experience') == '1-2' ? 'selected' : '' }}>১-২ বছর</option>
                                        <option value="2-3" {{ old('experience') == '2-3' ? 'selected' : '' }}>২-৩ বছর</option>
                                        <option value="3-5" {{ old('experience') == '3-5' ? 'selected' : '' }}>৩-৫ বছর</option>
                                        <option value="5-7" {{ old('experience') == '5-7' ? 'selected' : '' }}>৫-৭ বছর</option>
                                        <option value="7-10" {{ old('experience') == '7-10' ? 'selected' : '' }}>৭-১০ বছর</option>
                                        <option value="10+" {{ old('experience') == '10+' ? 'selected' : '' }}>১০+ বছর</option>
                                    </select>
                                    @error('experience')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="meta_description" 
                                          ...
                                          rows="2"
                                          placeholder="SEO ডেসক্রিপশন লিখুন">{{ old('meta_description') }}</textarea>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-section">
                            ...
                            <div class="text-center">
                                <div class="image-preview-container">
                                    <img src="https://ui-avatars.com/api/?name=User&size=150&background=6366f1&color=fff&rounded=true" 
                                         alt="Profile Preview" 
                                         class="image-preview"
                                         id="imagePreview">
                        ...
                        <div class="form-section">
                            ...
                            <div class="form-check form-switch">
                                ...
                                <label class="form-check-label" for="statusSwitch">
                                    <span id="statusLabel">{{ old('is_active', '1') == '1' ? 'সক্রিয়' : 'নিষ্ক্রিয়' }}</span>
                                </label>
                            </div>
                        ...
                        <div class="form-section">
                            ...
                            <div class="card">
                                <div class="card-body text-center">
                                    <img src="https://ui-avatars.com/api/?name=User&size=80&background=6366f1&color=fff&rounded=true" 
                                         alt="Preview" 
                                         class="rounded-circle mb-2"
                                         style="width: 80px; height: 80px; object-fit: cover;"
                                         id="previewImage">
                                    <h6 id="previewName">নাম</h6>
                                    <p class="text-muted small" id="previewDesignation">ডিজাইনেশন</p>
                        ...
                        <div class="form-section">
                            <button type="submit" class="btn btn-primary w-100 mb-2" id="submitBtn">
                                <i class="fas fa-save"></i> টিম মেম্বার যোগ করুন
                            </button>
...
$(document).ready(function() {
    ...
    // Create skills container if not exists
    if (!skillsContainer.length) {
        skillsInput.after('<div id="skillsContainer" class="mt-2"></div>');
    }
    ...
    function addSkillTag(skill) {
        ...
        const tag = $(`
            <span class="skill-tag">
                ${skill}
                <span class="btn-remove-skill" onclick="$(this).parent().remove()">
