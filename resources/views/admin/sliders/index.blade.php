        ...
        <div class="col-md-3 mb-2 mb-md-0">
            <div class="input-group">
                ...
                <input type="text" id="search-input" class="form-control bg-light border-start-0"
                    placeholder="স্লাইডার খুঁজুন..." autocomplete="off" style="font-size: 13.5px;">
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col-lg-4 col-sm-6 col-12 mb-3 mb-lg-0">
                <div class="info-box shadow-sm border" style="border-radius: 8px; background: #ffffff;">
                    <span class="info-box-icon text-primary rounded"
                        style="background: rgba(0, 123, 255, 0.08); width: 55px; height: 55px;"><i
                            class="fas fa-images"></i></span>
                    <div class="info-box-content ps-3">
                        <span class="info-box-text text-muted font-weight-bold text-uppercase"
                            style="font-size: 11px; letter-spacing: 0.5px;">মোট স্লাইডার</span>
                        <h4 class="info-box-number mb-0 font-weight-bold text-dark"
                            style="font-family: 'Baloo Da 2', sans-serif;">{{ $stats['total'] }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-12 mb-3 mb-lg-0">
                <div class="info-box shadow-sm border" style="border-radius: 8px; background: #ffffff;">
                    <span class="info-box-icon text-success rounded"
                        style="background: rgba(40, 167, 69, 0.08); width: 55px; height: 55px;"><i
                            class="fas fa-check-circle"></i></span>
                    <div class="info-box-content ps-3">
                        <span class="info-box-text text-muted font-weight-bold text-uppercase"
                            style="font-size: 11px; letter-spacing: 0.5px;">সক্রিয় স্লাইডার</span>
                        <h4 class="info-box-number mb-0 font-weight-bold text-dark"
                            style="font-family: 'Baloo Da 2', sans-serif;">{{ $stats['active'] }}</h4>
                    </div>
                </div>
            </div>
            <div class="col-lg-4 col-sm-6 col-12">
                <div class="info-box shadow-sm border" style="border-radius: 8px; background: #ffffff;">
                    <span class="info-box-icon text-danger rounded"
                        style="background: rgba(220, 53, 69, 0.08); width: 55px; height: 55px;"><i
                            class="fas fa-times-circle"></i></span>
                    <div class="info-box-content ps-3">
                        <span class="info-box-text text-muted font-weight-bold text-uppercase"
                            style="font-size: 11px; letter-spacing: 0.5px;">নিষ্ক্রিয় স্লাইডার</span>
                        <h4 class="info-box-number mb-0 font-weight-bold text-dark"
                            style="font-family: 'Baloo Da 2', sans-serif;">{{ $stats['inactive'] }}</h4>
                    </div>
                </div>
            </div>
        </div>
        ...
        $(document).ready(function() {
            ...
            function attachEventHandlers() {
                ...
                $(document).off('click', '.pagination a').on('click', '.pagination a', function(e) {
                    e.preventDefault();
                    var page = $(this).attr('href').match(/page=(\d+)/) ? $(this).attr('href').match(
                        /page=(\d+)/)[1] : 1;
