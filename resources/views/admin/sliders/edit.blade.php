        ...
        <div class="card shadow-sm border-0" style="border-radius: 8px; overflow: hidden;">
            ...
            <form action="{{ route('admin.sliders.update', $slider->id) }}" method="POST" enctype="multipart/form-data"
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-8">
                            ...
                            <div class="form-group mb-3">
                                <label class="form-label font-weight-bold text-secondary">শিরোনাম <span
                                        class="text-danger">*</span></label>
                                <input type="text" name="title"
                                    class="form-control @error('title') is-invalid @enderror"
                                    value="{{ old('title', $slider->title) }}"
                                    placeholder="স্লাইডারের শিরোনাম লিখুন (যেমন: অর্গানিক চাল-ডাল অফার)" required>
                                @error('title')
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="sub_title"
                                    ...
                                    placeholder="স্লাইডারের ছোট ডেসক্রিপশন বা স্লোগান">
                                @error('sub_title')
                                    <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                                @enderror
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="link"
                                            ...
                                            placeholder="যেমন: /books অথবা https://hezbuttawheed.org/books">
                                        @error('link')
                                            <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                                        @enderror
                                    </div>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label font-weight-bold text-secondary">লিংক টেক্সট
                                            (ঐচ্ছিক)</label>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label font-weight-bold text-secondary">বাটন টেক্সট
                                            (ঐচ্ছিক)</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="button_link"
                                            ...
                                            placeholder="যেমন: /offers বা https://bograbazar.com/offers">
                                        @error('button_link')
                                            <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                                        @enderror
                                    </div>
                                        ...
                                        <div class="input-group">
                                            <div class="input-group-prepend">
                                                <span class="input-group-text p-0"
                                                    style="width: 40px; height: 38px; overflow: hidden; border: 1px solid #ced4da; border-right: none; border-radius: 4px 0 0 4px;">
                                            ...
                                            <input type="text" name="button_color_text" id="button_color_text"
                                                class="form-control"
                                                value="{{ old('button_color', $slider->button_color ?? '#007bff') }}"
                                                placeholder="#007bff" style="border-radius: 0 4px 4px 0;">
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="target" class="form-control form-select">
                                            <option value="_self"
                                                {{ old('target', $slider->target) == '_self' ? 'selected' : '' }}>একই ট্যাব
                                                (_self)</option>
                                            <option value="_blank"
                                                {{ old('target', $slider->target) == '_blank' ? 'selected' : '' }}>নতুন
                                                ট্যাব (_blank)</option>
                                        </select>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="alt_text" class="form-control"
                                    ...
                                    placeholder="ছবির অল্টারনে티브 ডেসক্রিপশন">
                            </div>
                        </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card border-dashed mb-3 bg-light p-3 text-center"
                                style="border: 2px dashed #ced4da; border-radius: 6px;">
                                <label class="form-label font-weight-bold text-secondary d-block text-start mb-2">মূল ছবি
                                    (ডেস্কটপ) <span class="text-danger">*</span></label>
                                <div class="preview-container mb-2 text-center">
                                    @if ($slider->image && file_exists(public_path($slider->image)))
                                        <img id="image-preview" src="{{ asset($slider->image) }}" alt="Preview"
                                        ...
                                        <div id="image-placeholder" class="py-3" style="display: none;">
                                            ...
                                            <span class="text-xs text-muted" style="font-size: 11px;">JPG, PNG, WEBP
                                                (সর্বোচ্চ ২ মেগাবাইট)</span>
                                        </div>
                                    @else
                                        <img id="image-preview" src="#" alt="Preview" class="img-thumbnail"
                                            style="max-height: 120px; object-fit: contain; display: none;">
                                ...
                                <label for="image" class="btn btn-outline-primary btn-xs px-3 mb-0"
                                ...
                                @error('image')
                                    <div class="text-danger text-sm font-weight-bold mt-1">{{ $message }}</div>
                                @enderror
                                ...
                                @if ($slider->image)
                                    <div class="form-check mt-2 text-start">
                                        ...
                                        <label class="form-check-label text-danger font-weight-bold text-xs"
                                            for="remove_image" style="cursor: pointer;">
                                            <i class="fas fa-trash-alt mr-1"></i> বিদ্যমান ছবি মুছে ফেলুন
                                        </label>
                                    </div>
                                @endif
                                <div class="alert alert-info py-1 px-2 mt-2 mb-0 text-start"
                                    style="font-size: 11px; background-color: #e0f2fe; border-color: #bae6fd; color: #0369a1;">
                                    <i class="fas fa-info-circle me-1"></i> <strong>সুপারিশকৃত সাইজ:</strong> ১৯২০ x ৬৫০
                                    পিক্সেল (Aspect Ratio ~16:5)
                                </div>
                            </div>
                            ...
                            <div class="card border-dashed mb-3 bg-light p-3 text-center"
                                style="border: 2px dashed #ced4da; border-radius: 6px;">
                                <label class="form-label font-weight-bold text-secondary d-block text-start mb-2">মোবাইল
                                    ছবি (ঐচ্ছিক)</label>
                                <div class="preview-container mb-2 text-center">
                                    @if ($slider->mobile_image && file_exists(public_path($slider->mobile_image)))
                                        <img id="mobile-preview" src="{{ asset($slider->mobile_image) }}" alt="Preview"
                                        ...
                                        <div id="mobile-placeholder" class="py-3" style="display: none;">
                                            ...
                                            <span class="text-xs text-muted" style="font-size: 11px;">ফাঁকা রাখলে মূল ছবি
                                                ব্যবহৃত হবে</span>
                                        </div>
                                    @else
                                        <img id="mobile-preview" src="#" alt="Preview" class="img-thumbnail"
                                ...
                                <label for="mobile_image" class="btn btn-outline-secondary btn-xs px-3 mb-0"
                                    style="font-size: 12px; cursor: pointer;">
                                    <i class="fas fa-folder-open me-1"></i> ফাইল বেছে নিন
                                </label>
                                <input type="file" name="mobile_image" id="mobile_image" class="d-none"
                                    accept="image/jpeg,image/png,image/jpg,image/webp">
                                <div class="alert alert-success py-1 px-2 mt-2 mb-0 text-start"
                                    style="font-size: 11px; background-color: #f0fdf4; border-color: #bbf7d0; color: #15803d;">
                                    <i class="fas fa-mobile-alt me-1"></i> <strong>সুপারিশকৃত সাইজ:</strong> ৭৬৮ x ৬০০
                                    পিক্সেল (মোবাইল ডিভাইসের জন্য সেরা ভিউ)
                                </div>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="position" class="form-control form-select" required>
                                    <option value="homepage"
                                        {{ old('position', $slider->position) == 'homepage' ? 'selected' : '' }}>হোমপেজ
                                        স্লাইডার</option>
                                    <option value="banner"
                                        {{ old('position', $slider->position) == 'banner' ? 'selected' : '' }}>প্রমোショナル
                                        ব্যানার</option>
                                    <option value="popup"
                                        {{ old('position', $slider->position) == 'popup' ? 'selected' : '' }}>পপআপ ব্যানার
                                    </option>
                                </select>
                            </div>
                            ...
                            <div class="row">
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label font-weight-bold text-secondary"
                                            style="font-size: 13px;">শুরুর তারিখ</label>
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        <label class="form-label font-weight-bold text-secondary"
                                            style="font-size: 13px;">শেষ তারিখ</label>
                            ...
                            <div class="form-group mt-3 mb-2">
                                <div class="custom-control custom-switch">
                                    ...
                                    <label class="custom-control-label font-weight-bold text-success" for="status"
                ...
                <div class="card-footer bg-light border-top py-3 text-center">
                    ...
                    <a href="{{ route('admin.sliders.index') }}" class="btn btn-outline-secondary btn-lg px-4 ml-2"
                        style="border-radius: 4px; font-size: 15px;">
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#sliderForm').on('submit', function() {
                $('#submitBtn').html('<i class="fas fa-spinner fa-spin mr-1"></i> সংরক্ষণ হচ্ছে...').prop(
                    'disabled', true);
            });
        });
    </script>
