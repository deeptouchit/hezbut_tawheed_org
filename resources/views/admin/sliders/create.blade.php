                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <input type="text" name="button_link"
                                            ...
                                            placeholder="যেমন: /activities বা https://hezbuttawheed.org/activities">
                                        @error('button_link')
                                            <span class="invalid-feedback font-weight-bold">{{ $message }}</span>
                                        @enderror
                                    </div>
                                    ...
                                    <div class="form-group mb-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" name="button_color_text" id="button_color_text"
                                                class="form-control" value="{{ old('button_color', '#007bff') }}"
                                ...
                                <div class="col-md-6">
                                    <div class="form-group mb-3">
                                        ...
                                        <select name="target" class="form-control form-select">
                                            <option value="_self" {{ old('target') == '_self' ? 'selected' : '' }}>একই
                                                ট্যাব (_self)</option>
                                            <option value="_blank" {{ old('target') == '_blank' ? 'selected' : '' }}>নতুন
                                                ট্যাব (_blank)</option>
                                        </select>
                                    </div>
                                </div>
                        ...
                        <div class="col-lg-4">
                            ...
                            <div class="card border-dashed mb-3 bg-light p-3 text-center"
                                ...
                                <div class="preview-container mb-2 text-center">
                                    ...
                                    <div id="image-placeholder" class="py-3">
                                        ...
                                        <span class="text-xs text-muted" style="font-size: 11px;">JPG, PNG, WEBP (সর্বোচ্চ
                                            ২ মেগাবাইট)</span>
                                    </div>
                                </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="position" class="form-control form-select" required>
                                    <option value="homepage" {{ old('position') == 'homepage' ? 'selected' : '' }}>হোমপেজ
                                        স্লাইডার</option>
                                    <option value="banner" {{ old('position') == 'banner' ? 'selected' : '' }}>প্রমোশনাল
                                        ব্যানার</option>
                                    <option value="popup" {{ old('position') == 'popup' ? 'selected' : '' }}>পপআপ ব্যানার
                                    </option>
                                </select>
                            </div>
