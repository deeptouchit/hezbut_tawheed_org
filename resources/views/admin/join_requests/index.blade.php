...
@section('page-title', 'Membership Application Management')
            ...
            <div class="row g-2 align-items-center">
                <div class="col-md-3 col-sm-6">
                    <input type="text" id="search-input" class="form-control"
                        placeholder="নাম, মোবাইল, পিতা, ঠিকানা খুঁজুন..." autocomplete="off" value="{{ request('search') }}">
                </div>
                <div class="col-md-2 col-sm-6">
                    <select id="type-filter" class="form-select">
                        <option value="">সব আবেদনের ধরন</option>
                        <option value="primary" {{ request('membership_type') == 'primary' ? 'selected' : '' }}>প্রাথমিক
                            সদস্য</option>
                        <option value="pledge" {{ request('membership_type') == 'pledge' ? 'selected' : '' }}>পাঁচ দফা
                            ভিত্তিক অঙ্গীকার</option>
                    </select>
                </div>
                <div class="col-md-2 col-sm-6">
                    <select id="status-filter" class="form-select">
                        ...
                        <option value="rejected" {{ request('status') == 'rejected' ? 'selected' : '' }}>প্রত্যাখ্যাত
                        </option>
                    </select>
                </div>
                <div class="col-md-2 col-sm-6">
                    <input type="date" id="date-from-filter" class="form-control" placeholder="তারিখ থেকে"
        ...
        <div class="card">
            <div class="card-header">
                ...
                <div class="card-tools">
                    <div class="btn-group">
                        <select id="bulk-status-select" class="form-select form-select-sm me-2"
    ...
    <div class="modal fade" id="bulkDeleteModal" tabindex="-1" aria-labelledby="bulkDeleteModalLabel"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    আপনি কি নিশ্চিত যে আপনি নির্বাচিত <strong id="bulk-delete-count"></strong> টি আবেদন স্থায়ীভাবে মুছে
                    ফেলতে চান?
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">বাতিল</button>
