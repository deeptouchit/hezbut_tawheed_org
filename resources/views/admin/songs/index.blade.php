...
@section('page-title', '🎵 Song & Lyrics Management')
...
@push('styles')
    <style>
        ...
        .metric-card-modern.primary::before {
            background: linear-gradient(90deg, #006A4E, #00A876);
        }

        .metric-card-modern.success::before {
            background: linear-gradient(90deg, #2e7d32, #66bb6a);
        }

        .metric-card-modern.danger::before {
            background: linear-gradient(90deg, #d32f2f, #ef5350);
        }

        .metric-card-modern.info::before {
        ...
        .metric-card-modern .metric-icon.primary {
            background: rgba(0, 106, 78, 0.12);
            color: #006A4E;
        }

        .metric-card-modern .metric-icon.success {
            background: rgba(46, 125, 50, 0.12);
            color: #2e7d32;
        }

        .metric-card-modern .metric-icon.danger {
            background: rgba(211, 47, 47, 0.12);
            color: #d32f2f;
        }

        .metric-card-modern .metric-icon.info {
        ...
        .table-modern .song-category.national {
            background: rgba(0, 106, 78, 0.12);
            color: #006A4E;
        }

        .table-modern .song-category.awakening {
            background: rgba(211, 47, 47, 0.12);
            color: #d32f2f;
        }

        .table-modern .song-category.party_anthem {
            background: rgba(2, 136, 209, 0.12);
            color: #0288d1;
        }
        ...
        .action-group .btn-action.play:hover {
        ...
        <div class="filter-bar">
            <div class="filter-group">
                <div class="input-group">
                    ...
                    <input type="text" id="search-input" class="form-control" placeholder="শিরোনাম বা লিরিক্স খুঁজুন..."
            ...
            <div class="filter-group" style="flex: 0 0 120px;">
                <select id="per-page-filter" class="form-select">
                    ...
                    <option value="15" {{ request('per_page') == 15 || request('per_page') == '' ? 'selected' : '' }}>১৫
                    </option>
            ...
            <div class="modal-content" style="border-radius: 16px; border: none; box-shadow: 0 20px 60px rgba(0,0,0,0.15);">
                ...
                <div class="modal-footer" style="border-top: none; padding-top: 0; gap: 8px;">
                    <button type="button" class="btn btn-light" data-bs-dismiss="modal"
                        style="border-radius: 10px; font-weight: 500;">বাতিল</button>
