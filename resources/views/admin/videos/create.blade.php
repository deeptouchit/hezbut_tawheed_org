...
@section('page-title', 'নতুন ভিডিও যোগ করুন')
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-4">
        <h3 class="mb-0 fw-bold text-dark-green"><i class="fab fa-youtube text-danger me-1"></i> নতুন ভিডিও যোগ করুন</h3>
    ...
    <form action="{{ route('admin.videos.store') }}" method="POST" id="createVideoForm">
        @csrf
        <div class="row">
            ...
            <div class="col-md-9">
                <div class="form-section shadow-sm bg-white border border-light">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="যেমন: হেযবুত তওহীদের লক্ষ্য ও উদ্দেশ্য" value="{{ old('title') }}" required>
                        @error('title')
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="youtube_id" id="youtube_id" class="form-control @error('youtube_id') is-invalid @enderror" placeholder="যেমন: https://www.youtube.com/watch?v=uBqA0sT8Xic অথবা শুধু ID: uBqA0sT8Xic" value="{{ old('youtube_id') }}" required>
                    ...
                    <div class="mb-3">
                        ...
                        <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="5" placeholder="ভিডিওটির সারসংক্ষেপ এখানে লিখুন...">{{ old('description') }}</textarea>
                        @error('description')
                            <div class="invalid-feedback">{{ $message }}</div>
                        @enderror
                    </div>
            ...
            <div class="col-md-3">
                <div class="form-section shadow-sm bg-white border border-light">
                    ...
                    <button type="submit" class="btn btn-success w-100 mb-2">
                        <i class="fas fa-save me-1"></i> ভিডিও সংরক্ষণ করুন
                    </button>
