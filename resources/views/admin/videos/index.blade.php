...
@section('page-title', 'YouTube Video Management')
            ...
            <div class="row g-2">
                <div class="col-md-5 col-sm-6">
                    <div class="input-group">
                        ...
                        <input type="text" id="search-input" class="form-control"
                            placeholder="শিরোনাম, ভিডিও আইডি বা বিবরণ খুঁজুন..." autocomplete="off"
                ...
                <div class="col-md-3 col-sm-6">
                    <select id="per-page-filter" class="form-select">
                        ...
                        <option value="15"
                            {{ request('per_page') == 15 || request('per_page') == '' ? 'selected' : '' }}>১৫টি</option>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h5 class="mb-0 fw-bold" id="metric-inactive">{{ number_format($stats['inactive'] ?? 0) }}
                                </h5>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteModalLabel"><i class="fas fa-exclamation-triangle"></i> নিশ্চিত করুন
                    </h5>
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger small mb-0"><i class="fas fa-exclamation-triangle"></i> এই ডাটা ডিলিট হলে আর
                        ফেরত আনা যাবে না!</p>
                </div>
