...
@section('page-title', 'Photo Gallery & Media Library')
                ...
                <ul class="nav nav-tabs border-bottom-0" id="galleryTabs" role="tablist">
                    <li class="nav-item" role="presentation">
                        <button class="nav-link active" id="library-tab" data-bs-toggle="tab" data-bs-target="#library-pane"
                            type="button" role="tab" aria-controls="library-pane" aria-selected="true">
                            <i class="fas fa-photo-video me-2"></i> মিডিয়া লাইব্রেরি
                        </button>
                    </li>
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="homepage-tab" data-bs-toggle="tab" data-bs-target="#homepage-pane"
                            type="button" role="tab" aria-controls="homepage-pane" aria-selected="false">
                    ...
                    <li class="nav-item" role="presentation">
                        <button class="nav-link" id="gallerypage-tab" data-bs-toggle="tab"
                            data-bs-target="#gallerypage-pane" type="button" role="tab"
                            aria-controls="gallerypage-pane" aria-selected="false">
                            <i class="fas fa-images me-2"></i> গ্যালারি পেজ
                            <span class="badge bg-info ms-2 text-white"
                                id="gallerypage-counter">{{ count($galleryPagePosts) }}</span>
                        </button>
                    </li>
                </ul>
            </div>
                ...
                <div class="tab-content" id="galleryTabsContent">
                        ...
                        <div class="row mb-4">
                            <div class="col-md-12">
                                <div class="card border shadow-none bg-light">
                                    <div class="card-body">
                                        <h6 class="fw-bold mb-3"><i class="fas fa-cloud-upload-alt text-success me-2"></i>
                                            নতুন ছবি আপলোড (ব্লগ পোস্টের বাইরে সরাসরি গ্যালারির জন্য)</h6>
                                        <form id="upload-gallery-form" action="{{ route('admin.gallery.upload') }}"
                                            method="POST" enctype="multipart/form-data">
                                            @csrf
                                            <div class="row align-items-end">
                                                <div class="col-md-5 mb-2">
                                                    <label class="form-label text-muted small">ছবির শিরোনাম /
                                                        ক্যাপশন</label>
                                                ...
                                                <div class="col-md-4 mb-2">
                                                    <label class="form-label text-muted small">ছবি ফাইল নির্বাচন
                                                        করুন</label>
                    ...
                    <div class="tab-pane fade" id="homepage-pane" role="tabpanel" aria-labelledby="homepage-tab">
                        <div class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2">
                            ...
                            <span class="text-muted small"><i class="fas fa-arrows-alt me-1"></i> ড্র্যাগ করে ইচ্ছামত
                                ক্রমানুসারে সাজান</span>
                        </div>
                        ...
                        <div class="active-grid" id="homepage-sortable">
                            @forelse($homepagePosts as $item)
                                <div class="active-grid-item" data-id="{{ $item->id }}">
                                    ...
                                    <button class="active-grid-remove toggle-homepage" data-id="{{ $item->id }}"
                    ...
                    <div class="tab-pane fade" id="gallerypage-pane" role="tabpanel" aria-labelledby="gallerypage-tab">
                        <div class="d-flex align-items-center justify-content-between mb-3 border-bottom pb-2">
                            ...
                            <span class="text-muted small"><i class="fas fa-arrows-alt me-1"></i> ড্র্যাগ করে গ্যালারি
                                পেজের ক্রমানুসার সাজান</span>
                        </div>
                        ...
                        <div class="active-grid" id="gallerypage-sortable">
                            @forelse($galleryPagePosts as $item)
                                <div class="active-grid-item" data-id="{{ $item->id }}">
                                    <img src="{{ asset($item->image_path) }}" alt="">
                                    <button class="active-grid-remove toggle-gallerypage" data-id="{{ $item->id }}"
                                        title="গ্যালারি পেজ থেকে বাদ দিন">
                                        <i class="fas fa-times"></i>
                                    </button>
                                </div>
                            @empty
    ...
    <script>
        $(document).ready(function() {
                ...
                Sortable.create(gpEl, {
                    ...
                    onEnd: function() {
                        ...
                        $.ajax({
                            ...
                            error: function() {
                                toastr.error(
                                    'গ্যালারি পেজ সর্ট অর্ডার আপডেট করতে ব্যর্থ হয়েছে');
                            }
                        });
                    }
                });
                        ...
                        if (response.success && response.html) {
                            if (page === 1) {
                                ...
                                `);
                                        ...
                                        $('#load-more-btn').attr('data-page', 2).prop('disabled', false)
                                            .html(
                                                '<i class="fas fa-sync-alt me-1"></i> আরো ছবি লোড করুন'
                                                );
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            if (card.length > 0) {
                                ...
                                if (response.show_on_homepage) {
                                    mainLibraryBtn.addClass('btn-success').removeClass(
                                        'btn-outline-success');
                                    if (container.find('.badge-hp-indicator').length === 0) {
                                        container.append(
                                            '<span class="badge bg-success badge-hp-indicator" title="হোমপেজে সক্রিয়" style="border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; padding: 0;"><i class="fas fa-home" style="font-size: 10px;"></i></span>'
                                            );
                                    }
                                } else {
                                    mainLibraryBtn.addClass('btn-outline-success').removeClass(
                                        'btn-success');
                            ...
                            if (response.show_on_homepage) {
                                ...
                                if (!imgUrl) {
                                    imgUrl = homepageGridRemoveBtn.siblings('img').attr(
                                        'src') || '';
                                }
                        ...
                        <div class="active-grid-item" data-id="${id}">
                            ...
                            <button class="active-grid-remove toggle-homepage" data-id="${id}" title="হোমপেজ থেকে বাদ দিন">
                                ...
                                $('#homepage-sortable [data-id="' + id + '"]').fadeOut(300,
                                    function() {
                                        $(this).remove();
                                        updateCounters();
                                    });
            ...
            $(document).on('click', '.toggle-gallerypage', function(e) {
                ...
                var galleryPageGridRemoveBtn = $('#gallerypage-sortable [data-id="' + id +
                    '"] .toggle-gallerypage');
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            if (card.length > 0) {
                                ...
                                if (response.show_on_gallery) {
                                    mainLibraryBtn.addClass('btn-info text-white').removeClass(
                                        'btn-outline-info');
                                    if (container.find('.badge-gp-indicator').length === 0) {
                                        container.append(
                                            '<span class="badge bg-info badge-gp-indicator" title="গ্যালারি পেজে সক্রিয়" style="border-radius: 50%; width: 24px; height: 24px; display: flex; align-items: center; justify-content: center; padding: 0; color: white;"><i class="fas fa-images" style="font-size: 10px;"></i></span>'
                                            );
                                    }
                                } else {
                                    mainLibraryBtn.addClass('btn-outline-info').removeClass(
                                        'btn-info text-white');
                            ...
                            if (response.show_on_gallery) {
                                var imgUrl = $('#card-' + id + ' .media-img').attr('src');
                                if (!imgUrl) {
                                    imgUrl = galleryPageGridRemoveBtn.siblings('img').attr(
                                        'src') || '';
                                }
                        ...
                        <div class="active-grid-item" data-id="${id}">
                            ...
                            <button class="active-grid-remove toggle-gallerypage" data-id="${id}" title="গ্যালারি পেজ থেকে বাদ দিন">
                                ...
                                $('#gallerypage-sortable [data-id="' + id + '"]').fadeOut(300,
                                    function() {
                                        $(this).remove();
                                        updateCounters();
                                    });
            ...
            $(document).on('click', '.delete-custom', function() {
                ...
                if (confirm(
                        'আপনি কি এই ছবিটি গ্যালারি মিডিয়া লাইব্রেরি ও স্টোরেজ থেকে চিরতরে ডিলিট করতে চান?'
                        )) {
                    btn.prop('disabled', true);
                    $.ajax({
                        ...
                        success: function(response) {
                            ...
                            if (response.success) {
                                ...
                                $('#homepage-sortable [data-id="' + id + '"]').fadeOut(400,
                                    function() {
                                        $(this).remove();
                                        updateCounters();
                                    });

                                $('#gallerypage-sortable [data-id="' + id + '"]').fadeOut(400,
                                    function() {
                                        $(this).remove();
                                        updateCounters();
                                    });
            ...
            $('#upload-gallery-form').on('submit', function(e) {
                ...
                submitBtn.prop('disabled', true).html(
                    '<i class="fas fa-spinner fa-spin me-1"></i> আপলোড হচ্ছে...');
