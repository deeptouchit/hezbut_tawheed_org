            ...
            <div class="card-header bg-white py-3">
                ...
                <div class="card-tools">
                    <div class="btn-group">
                        ...
                        <button class="btn btn-danger btn-sm delete-suggestion" data-id="{{ $suggestion->id }}"
                ...
                <div class="row">
                    ...
                    <div class="col-md-8">
                        <div class="detail-card">
                            <div class="detail-header">
                                <div class="sender-info">
                                    <img src="https://ui-avatars.com/api/?name={{ urlencode($suggestion->name) }}&size=60&background=10b981&color=fff&rounded=true"
                                        alt="{{ $suggestion->name }}" class="sender-avatar">
                                    <div>
                                ...
                                <div>
                                    @if ($suggestion->status == 'pending')
                                        <span class="badge bg-warning text-dark py-2 px-3"><i class="fas fa-clock"></i>
                                            পেন্ডিং</span>
                                    @else
                                        <span class="badge bg-success py-2 px-3"><i class="fas fa-check-circle"></i>
                                            রিভিউড</span>
                                    @endif
                                </div>
                            </div>
                            ...
                            <div class="mb-4">
                                <h5 class="fw-bold"><i class="fas fa-bookmark text-primary me-1"></i> বিষয়:
                                    {{ $suggestion->subject ?? 'মতামত/পরামর্শ' }}</h5>
                            </div>
                            ...
                            <div class="meta-box">
                                <div class="meta-item">
                                    <span class="label"><i class="fas fa-globe"></i> প্রকাশের অনুমতি</span>
                                    <span class="value">
                                        @if ($suggestion->allow_publish)
                                            <span class="badge bg-success"><i class="fas fa-check-circle me-1"></i> অনুমতি
                                                দেওয়া হয়েছে (প্রকাশযোগ্য)</span>
                                        @else
                                            <span class="badge bg-secondary"><i class="fas fa-lock me-1"></i> শুধুমাত্র গোপন
                                                ইনবক্স (প্রাইভেট)</span>
                                        @endif
                                    </span>
                                </div>
                                <div class="meta-item">
                                ...
                                @if ($suggestion->user_agent)
                                    <div class="meta-item">
                                        ...
                                        <span
                                            class="value"><small>{{ Str::limit($suggestion->user_agent, 80) }}</small></span>
                                    </div>
                                @endif
                            </div>
                        </div>
                    ...
                    <div class="col-md-4">
                        <div class="card shadow-sm">
                            <div class="card-header bg-dark text-white">
                                <h5 class="card-title mb-0" style="font-size: 1rem;"><i class="fas fa-info-circle me-1"></i>
                                    কুইক ইনফো</h5>
                            </div>
