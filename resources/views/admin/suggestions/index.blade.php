...
@section('page-title', 'Feedback & Suggestion Management')
                ...
                <div class="col-md-4 mb-3">
                    <div class="input-group">
                        ...
                        <input type="text" name="search" class="form-control"
                            placeholder="নাম, কন্টাক্ট, বিষয় বা বার্তা..." value="{{ request('search') }}">
                    </div>
                </div>
                <div class="col-md-3 mb-3">
                    <select name="status" class="form-select">
                        <option value="">সব স্ট্যাটাস</option>
                        <option value="pending" {{ request('status') == 'pending' ? 'selected' : '' }}>পেন্ডিং (অপঠিত)
                        </option>
                        <option value="reviewed" {{ request('status') == 'reviewed' ? 'selected' : '' }}>রিভিউড (পঠিত)
                        </option>
                    </select>
                </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <p>আপনি কি নিশ্চিত যে আপনি <strong id="delete-name"></strong> এর পাঠানো পরামর্শ বার্তাটি ডিলিট করতে
                        চান?</p>
