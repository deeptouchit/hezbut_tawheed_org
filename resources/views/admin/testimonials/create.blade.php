...
@section('page-title', 'নতুন টেস্টিমোনিয়াল যোগ করুন')
...
<div class="container-fluid">
    <div class="card">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-star me-2"></i> নতুন টেস্টিমোনিয়াল যোগ করুন
            </h3>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-section">
                            ...
                            <div class="text-center">
                                <div class="image-preview-container">
                                    <img src="https://ui-avatars.com/api/?name=Client&size=120&background=6366f1&color=fff&rounded=true" 
                                         alt="Avatar Preview" 
                                         class="image-preview"
                                         id="imagePreview">
                        ...
                        <div class="form-section">
                            ...
                            <div class="text-center">
                                <div class="rating-stars-input" id="ratingStars">
                                    <input type="radio" name="rating" value="5" id="star5" {{ old('rating', 5) == 5 ? 'checked' : '' }}>
                        ...
                        <div class="form-section">
                            ...
                            <div class="preview-card">
                                <img src="https://ui-avatars.com/api/?name=Client&size=80&background=6366f1&color=fff&rounded=true" 
                                     alt="Preview" 
                                     class="avatar"
                                     id="previewAvatar">
                                <div class="name" id="previewName">ক্লায়েন্টের নাম</div>
                                <div class="designation" id="previewDesignation">ডিজাইনেশন</div>
                                <div class="designation text-muted" id="previewCompany">কোম্পানি</div>
                                ...
                                <div class="content" id="previewContent">
                                    ক্লায়েন্টের মতামত এখানে দেখানো হবে...
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-section">
                            <button type="submit" class="btn btn-primary w-100 mb-2" id="submitBtn">
                                <i class="fas fa-save"></i> টেস্টিমোনিয়াল যোগ করুন
                            </button>
...
$(document).ready(function() {
    ...
    $('input[name="name"]').on('keyup', function() {
        ...
        if (!$('#avatarInput').get(0).files.length) {
    ...
    // ============================================
    const initialRating = $('input[name="rating"]:checked').val() || 5;
    const stars = $('#previewRating');
    stars.empty();
    for (let i = 1; i <= 5; i++) {
        if (i <= initialRating) {
