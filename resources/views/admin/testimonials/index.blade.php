...
@section('page-title', 'Testimonial Management')
    ...
    <div class="row px-3">
        <div class="col-md-4 mb-3">
            <div class="input-group">
                ...
                <input type="text" id="search-input" class="form-control" placeholder="নাম, কোম্পানি, কন্টেন্ট..."
                    autocomplete="off">
            </div>
        </div>
            ...
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    <span class="badge bg-primary ms-2"
                        id="total-count">{{ $testimonials->total() ?? $testimonials->count() }}</span>
                </h3>
                                ...
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="text-muted small d-block mb-0"
                                            style="font-size: 11px;">নিষ্ক্রিয়</span>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card metric-card border-left-warning h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="text-muted small d-block mb-0" style="font-size: 11px;">গড়
                                            রেটিং</span>
                    ...
                    <div class="col-md-3 col-6">
                        <div class="card metric-card border-left-secondary h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="text-muted small d-block mb-0" style="font-size: 11px;">রেটিং
                                            ডিস্ট্রিবিউশন</span>
                                        <div class="mt-1">
                                            @foreach ($stats['ratings'] ?? [] as $star => $count)
                                                <span class="badge bg-warning text-dark me-1"
                                                    style="font-size: 9px; padding: 2px 4px;">{{ $star }}★:
                                                    {{ $count }}</span>
                                            @endforeach
                                        </div>
                                    </div>
