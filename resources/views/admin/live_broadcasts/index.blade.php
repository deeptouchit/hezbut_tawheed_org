...
@section('page-title', 'Live Broadcast Management')
    ...
    <div class="row px-3">
        <div class="col-md-6 mb-3">
            <div class="input-group">
                ...
                <input type="text" id="search-input" class="form-control" placeholder="শিরোনাম, ভিডিও আইডি বা বিবরণ..."
                    autocomplete="off">
            </div>
        </div>
            ...
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    <span class="badge bg-primary ms-2"
                        id="total-count">{{ $broadcasts->total() ?? $broadcasts->count() }}</span>
                </h3>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteModalLabel"><i class="fas fa-exclamation-triangle"></i> ডিলিট নিশ্চিত
                        করুন</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>আপনি কি নিশ্চিত যে আপনি "<strong><span id="delete-item-name"></span></strong>" লাইভ অনুষ্ঠানটি ডিলিট
                        করতে চান?</p>
