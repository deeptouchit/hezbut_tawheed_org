...
@section('filter_input')
    ...
    <div class="row px-3">
        <div class="col-md-3">
            <input type="text" id="search-input" class="form-control" placeholder="ইউজার খুঁজুন..."
        ...
        <div class="col-md-3">
            <select id="per-page-filter" class="form-control">
                ...
                <option value="20"
                    {{ request('per_page') == 20 ? 'selected' : (request('per_page') == '' ? 'selected' : '') }}>২০টি দেখান
                </option>
            ...
            function attachEventHandlers() {
                ...
                $('.bulk-delete').off('click').on('click', function() {
                    ...
                    Swal.fire({
                        title: 'আপনি কি নিশ্চিত?',
                        text: ids.length +
                            " টি ইউজার মুছে ফেলতে যাচ্ছেন! এই ইউজারদের সকল ডাটা মুছে যাবে।",
                        icon: 'warning',
                        showCancelButton: true,
                        confirmButtonColor: '#d33',
                        cancelButtonColor: '#3085d6',
