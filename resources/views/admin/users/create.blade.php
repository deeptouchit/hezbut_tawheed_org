        ...
        <div class="card user-card">
            ...
            <div class="card-header d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-3">
                    ...
                    <div>
                        <h5 class="mb-0 text-dark fw-bold" style="font-size: 1.2rem;">নতুন ইউজার তৈরি করুন</h5>
                        <small class="text-muted">সিস্টেমে নতুন ব্যবহারকারীর জন্য তথ্য ফিলআপ করুন</small>
                    </div>
                </div>
                <div>
            ...
            <form action="{{ route('admin.users.store') }}" method="POST">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control @error('name') is-invalid @enderror"
                                            ...
                                            placeholder="ব্যবহারকারীর পুরো নাম লিখুন" required>
                                        @error('name')
                    ...
                    <div class="mb-4">
                        <div class="section-title d-flex justify-content-between align-items-center flex-wrap gap-2">
                            <div>
                                ...
                                <span>সিকিউরিটি ও অ্যাক্সেস ক্রেডেনশিয়াল</span>
                            </div>
                        ...
                        <div class="row g-3">
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password" class="form-label">পাসওয়ার্ড <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-key"></i></span>
                                        <input type="password" class="form-control @error('password') is-invalid @enderror"
                                            id="password" name="password" placeholder="পাসওয়ার্ড লিখুন (নূন্যতম ৮ অক্ষর)"
                                            required>
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="password_confirmation" class="form-label">পাসওয়ার্ড নিশ্চিত করুন <span
                                            class="text-danger">*</span></label>
                                    <div class="input-group">
                                        <span class="input-group-text"><i class="fas fa-shield-alt"></i></span>
                                        <input type="password" class="form-control" id="password_confirmation"
                                            name="password_confirmation" placeholder="পাসওয়ার্ড পুনরায় লিখুন" required>
                                        <button class="btn btn-toggle-eye toggle-password" type="button"
                        ...
                        <div class="row g-3 align-items-center">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <select class="form-control form-select @error('status') is-invalid @enderror"
                                            ...
                                            <option value="active"
                                                {{ old('status', 'active') == 'active' ? 'selected' : '' }}>সক্রিয়
                                                (Active)</option>
                                            <option value="inactive" {{ old('status') == 'inactive' ? 'selected' : '' }}>
                                                নিষ্ক্রিয় (Inactive)</option>
                                            <option value="suspended"
                                                {{ old('status') == 'suspended' ? 'selected' : '' }}>সাসপেন্ডেড (Suspended)
                                            </option>
                                        </select>
                                        @error('status')
                                            <span class="invalid-feedback">{{ $message }}</span>
                            ...
                            <div class="col-md-4">
                                <div class="form-group pt-md-4">
                                    <div class="custom-switch-card d-flex align-items-center justify-content-between">
                                        <label class="form-check-label mb-0 fw-semibold text-dark cursor-pointer"
                                            for="verify_email">
                                            <i class="fas fa-check-circle text-primary me-2"></i> ইমেইল ভেরিফাইড মার্ক করুন
                                        </label>
                                        <div class="form-check form-switch mb-0 me-0">
                                            <input type="checkbox" class="form-check-input" id="verify_email"
                                                name="verify_email" value="1"
                ...
                <div class="card-footer-custom d-flex align-items-center justify-content-end gap-2">
                    ...
                    <button type="submit" class="btn btn-primary px-4 fw-semibold"
                        ...
                        <i class="fas fa-save me-1"></i> ইউজার তৈরি করুন
                    </button>
                </div>
            </form>
        </div>
