...
@section('page-title', 'Contact Message Management')
        ...
        <div class="row align-items-end">
            <div class="col-md-3 mb-3">
                <div class="input-group">
                    ...
                    <input type="text" id="search-input" class="form-control" placeholder="নাম, ইমেইল, বার্তা..."
            ...
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    <span class="badge bg-primary ms-2"
                        id="total-count">{{ $messages->total() ?? $messages->count() }}</span>
                </h3>
                        ...
                        <div class="card metric-card border-left-info h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="text-muted small d-block mb-0" style="font-size: 11px;">মোট
                                            বার্তা</span>
                    ...
                    <div class="col-md-2 col-6">
                        <div class="card metric-card border-left-success h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="text-muted small d-block mb-0" style="font-size: 11px;">উত্তর
                                            দেওয়া</span>
                    ...
                    <div class="col-md-2 col-6">
                        <div class="card metric-card border-left-secondary h-100">
                            <div class="card-body">
                                <div class="d-flex justify-content-between align-items-center">
                                    <div>
                                        <span class="text-muted small d-block mb-0" style="font-size: 11px;">এই
                                            সপ্তাহে</span>
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                error: function() {
                                    toastr.error(
                                        'বার্তা পড়া চিহ্নিত করতে ব্যর্থ হয়েছে');
                                }
                            });
                        }
                    });
