                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" id="title"
                                        ...
                                        value="{{ old('title') }}" placeholder="ব্লগ পোস্টের শিরোনাম লিখুন" required>
                                    @error('title')
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_description" id="shortDescription"
                                        ...
                                        placeholder="ব্লগ পোস্টের সংক্ষিপ্ত বিবরণ লিখুন (৫০০ অক্ষরের মধ্যে)">{{ old('short_description') }}</textarea>
                                    ...
                                    <div class="wp-editor-wrap">
                                        ...
                                        <div class="wp-editor-container">
                                            <textarea name="content" id="editor" class="form-control @error('content') is-invalid @enderror"
                                                placeholder="ব্লগ পোস্টের সম্পূর্ণ কন্টেন্ট লিখুন..." style="height: 450px;">{{ old('content') }}</textarea>
                                        </div>
                                    </div>
                                    @error('content')
                            ...
                            <div class="form-section">
                                ...
                                <div class="text-center">
                                    <div class="image-preview-container">
                                        <img src="{{ asset('images/default-blog.jpg') }}" alt="Featured Image"
                                ...
                                <select name="tags[]" id="tagSelect" class="form-select select2" multiple="multiple"
                                    ...
                                    @foreach ($tags as $tagString)
                                        <option value="{{ $tagString }}"
                                            {{ in_array($tagString, old('tags', [])) ? 'selected' : '' }}>
                                            {{ $tagString }}
                                        </option>
                                    @endforeach
                                </select>
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3 form-check form-switch">
                                    ...
                                    <input type="checkbox" name="is_gallery" id="isGallerySwitch"
                                        ...
                                        {{ old('is_gallery', 0) ? 'checked' : '' }}>
                                    <label for="isGallerySwitch" class="form-check-label" id="galleryLabel">গ্যালারিতে
                                        যুক্ত নয়</label>
                                </div>
                                <div class="mb-3" id="galleryOrderSection" style="display: none;">
                                    ...
                                    <input type="number" name="gallery_order" class="form-control"
                                        value="{{ old('gallery_order', 0) }}" min="0">
                                </div>
                                <div class="mb-3">
...
@push('scripts')
    <script>
        $(document).ready(function() {
            ...
            // 12. Video Insertion Helpers (YouTube & Facebook)
