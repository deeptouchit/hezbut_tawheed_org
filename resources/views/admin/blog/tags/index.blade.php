        ...
        <div class="card-body p-2">
            <div class="row g-2">
                <div class="col-md-3 col-sm-6">
                    <input type="text" id="search-input" class="form-control" placeholder="ট্যাগের নাম, বিবরণ খুঁজুন..."
                ...
                <div class="col-md-2 col-sm-6">
                    <select id="per-page-filter" class="form-select">
                        ...
                        <option value="20"
                            {{ request('per_page') == 20 ? 'selected' : (request('per_page') == '' ? 'selected' : '') }}>
                            ২০টি</option>
                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h5 class="mb-0 fw-bold" id="stats-inactive">{{ number_format($stats['inactive'] ?? 0) }}
                                </h5>
                            </div>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger"><small>⚠️ এই কাজটি অপরিবর্তনীয়! ডিলিট করার পর আর ফিরিয়ে আনা যাবে না।</small>
                    </p>
                    <div class="text-warning" id="delete-blog-warning" style="display: none;">
                        <i class="fas fa-exclamation-triangle"></i>
                        এই ট্যাগের অধীনে <strong id="delete-blog-count"></strong> টি ব্লগ পোস্ট আছে। প্রথমে ব্লগ পোস্ট গুলো
                        থেকে ট্যাগটি সরান!
                    </div>
                </div>
                ...
                <form id="modalTagForm" novalidate>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="name" id="modalTagName" class="form-control"
                                placeholder="ট্যাগের নাম লিখুন" required>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="text" name="slug" id="modalTagSlug" class="form-control"
                                placeholder="যেমন: anti-extremism">
                        ...
                        <div class="mb-3">
                            ...
                            <div class="d-flex align-items-center">
                                <input type="color" name="color" id="modalColor"
                                    class="form-control form-control-color me-2" value="#6c757d" title="রঙ নির্বাচন করুন"
                                    style="width: 45px; height: 38px; padding: 3px;">
                                <input type="text" id="modalColorHex" class="form-control" placeholder="#6c757d"
                                    value="#6c757d">
                            </div>
                        ...
                        <div class="mb-3">
                            ...
                            <input type="number" name="sort_order" id="modalSortOrder" class="form-control"
                                value="0">
                        ...
                        <div class="mb-3">
                            ...
                            <textarea name="description" id="modalTagDescription" rows="3" class="form-control"
                                placeholder="ট্যাগের সংক্ষিপ্ত বর্ণনা..."></textarea>
                            <div class="invalid-feedback d-block" id="error-description" style="display: none;"></div>
                        </div>

                        <!-- Status -->
                        <div class="mb-1 form-check form-switch">
                            <input type="checkbox" name="status" id="modalStatus" class="form-check-input"
                                value="1" checked>
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#modalTagForm').on('submit', function(e) {
                ...
                var url = method === 'POST' ? "{{ route('admin.blog.tags.store') }}" :
                    "{{ url('admin/blog/tags') }}/" + id;

                $('#saveTagBtn').prop('disabled', true).html(
                    '<i class="fas fa-spinner fa-spin me-1"></i> প্রসেসিং...');
                ...
                $.ajax({
                    ...
                    data: formData,
                    success: function(response) {
                        $('#saveTagBtn').prop('disabled', false).html(
                            '<i class="fas fa-save me-1"></i> ' + $('#saveBtnText').text());
                        if (response.success) {
                            $('#tagModal').modal('hide');
                            toastr.success(response.message);
                            loadTags();
                    ...
                    error: function(xhr) {
                        ...
                        if (xhr.status === 422) {
                            ...
                            $.each(errors, function(key, messages) {
                                ...
                                if (key === 'sort_order') inputField = $(
                                    '#modalSortOrder');
                                if (key === 'color') inputField = $('#modalColorHex');
                                if (key === 'description') inputField = $(
                                    '#modalTagDescription');
                            ...
                            var errorMsg = xhr.responseJSON && xhr.responseJSON.message ? xhr
                                .responseJSON.message : 'সার্ভারে সমস্যা হয়েছে';
