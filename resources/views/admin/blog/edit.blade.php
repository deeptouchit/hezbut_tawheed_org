...
@section('page-title', 'ব্লগ পোস্ট সম্পাদনা - ' . $blog->title)
    ...
    <div class="container-fluid">
        <div class="card shadow-sm">
            <div class="card-header bg-white d-flex align-items-center justify-content-between">
                <h5 class="mb-0 text-primary"><i class="fas fa-edit me-2"></i> ব্লগ পোস্ট সম্পাদনা</h5>
            ...
            <div class="card-body">
                <form action="{{ route('admin.blog.posts.update', $blog->id) }}" method="POST" enctype="multipart/form-data"
                    id="blogForm">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="row">
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" id="title"
                                        ...
                                        value="{{ old('title', $blog->title) }}" placeholder="ব্লগ পোস্টের শিরোনাম লিখুন"
                                        required>
                                    @error('title')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug"
                                        ...
                                        value="{{ old('slug', $blog->slug) }}" placeholder="স্লাগ লিখুন (ঐচ্ছিক)">
                                    <div class="slug-preview">
                                        <i class="fas fa-link me-1"></i>
                                        পোস্ট URL: <span class="slug-text"
                                            id="slugPreview">{{ url('/blog') }}/{{ $blog->slug }}</span>
                                    </div>
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="short_description" id="shortDescription"
                                        class="form-control @error('short_description') is-invalid @enderror" rows="3"
                                        placeholder="ব্লগ পোস্টের সংক্ষিপ্ত বিবরণ লিখুন (৫০০ অক্ষরের মধ্যে)">{{ old('short_description', $blog->short_description) }}</textarea>
                                    <div class="d-flex justify-content-end mt-1">
                                        <span class="text-muted small"
                                            id="descCount">{{ strlen(old('short_description', $blog->short_description)) }}/500</span>
                                    </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="wp-editor-wrap">
                                        <div class="wp-editor-tools-header d-flex justify-content-between align-items-end">
                                            <div class="wp-editor-media-buttons pb-2 d-flex flex-wrap gap-1">
                                                ...
                                                <button type="button" class="btn btn-outline-danger btn-sm border"
                                                    id="insertYoutubeBtn" title="YouTube ভিডিও যুক্ত করুন">
                                                    <i class="fab fa-youtube text-danger me-1"></i> YouTube ভিডিও
                                                </button>
                                                <button type="button" class="btn btn-outline-primary btn-sm border"
                                                    id="insertFbVideoBtn" title="Facebook ভিডিও যুক্ত করুন">
                                                    <i class="fab fa-facebook text-primary me-1"></i> Facebook ভিডিও
                                                </button>
                                            </div>
                                            <div class="wp-editor-tabs-nav">
                                                <button type="button" class="active-tab-btn"
                                                    id="editorVisualTab">Visual</button>
                                        ...
                                        <div id="codeModeButtons" class="bg-light p-2 border-bottom d-none flex-wrap gap-1">
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('b')"><strong>b</strong></button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('i')"><em>i</em></button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('a')">link</button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('blockquote')">b-quote</button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('del')"><del>del</del></button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('ins')"><ins>ins</ins></button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="insertTag('img')">img</button>
                                            <button type="button"
                                                class="btn btn-light btn-xs border py-0 px-2 text-danger"
                                                onclick="insertYoutubeVideo()"><i
                                                    class="fab fa-youtube me-1"></i>YouTube</button>
                                            <button type="button"
                                                class="btn btn-light btn-xs border py-0 px-2 text-primary"
                                                onclick="insertFacebookVideo()"><i
                                                    class="fab fa-facebook me-1"></i>Facebook</button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('ul')">ul</button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('ol')">ol</button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('li')">li</button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('code')">code</button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="wrapText('more')">more</button>
                                            <button type="button" class="btn btn-light btn-xs border py-0 px-2"
                                                onclick="closeTags()">close tags</button>
                                        </div>

                                        <div class="wp-editor-container">
                                            <textarea name="content" id="editor" class="form-control @error('content') is-invalid @enderror"
                                                placeholder="ব্লগ পোস্টের সম্পূর্ণ কন্টেন্ট লিখুন..." style="height: 450px;">{{ old('content', $blog->content) }}</textarea>
                                        </div>
                                    </div>
                                    @error('content')
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="meta_keywords" id="metaKeywords"
                                        ...
                                        placeholder="কীওয়ার্ডগুলো কমা (,) দিয়ে আলাদা করুন">
                                    @error('meta_keywords')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                        ...
                        <div class="col-md-4">
                            ...
                            <div class="form-section">
                                ...
                                <div class="text-center">
                                    <div class="image-preview-container">
                                        <img src="{{ $blog->featured_image ? asset($blog->featured_image) : asset('images/default-blog.jpg') }}"
                                            alt="Featured Image" class="image-preview" id="imagePreview">
                            ...
                            <div class="form-section">
                                ...
                                <select name="tags[]" id="tagSelect" class="form-select select2" multiple="multiple"
                                    style="width: 100%;">
                                    @foreach ($tags as $tagString)
                                        <option value="{{ $tagString }}"
                                            {{ in_array($tagString, old('tags', $blog->tags ?? [])) ? 'selected' : '' }}>
                                            {{ $tagString }}
                                        </option>
                                    @endforeach
                                </select>
                                <small class="text-muted d-block mt-1">ট্যাগ নির্বাচন করুন অথবা নতুন ট্যাগ লিখে Enter
                                    চাপুন।</small>
                                @error('tags')
                                    <div class="text-danger small mt-1">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="form-section">
                                ...
                                <div class="mb-3 form-check form-switch">
                                    ...
                                    <input type="checkbox" name="status" id="statusSwitch" class="form-check-input"
                                        value="1" {{ old('status', $blog->status) ? 'checked' : '' }}>
                                    <label for="statusSwitch" class="form-check-label"
                                        id="statusLabel">{{ $blog->status ? 'প্রকাশিত' : 'খসড়া' }}</label>
                                </div>
                                <div class="mb-3 form-check form-switch">
                                    <input type="hidden" name="is_gallery" value="0">
                                    <input type="checkbox" name="is_gallery" id="isGallerySwitch"
                                        class="form-check-input" value="1"
                                        {{ old('is_gallery', $blog->is_gallery) ? 'checked' : '' }}>
                                    <label for="isGallerySwitch" class="form-check-label"
                                        id="galleryLabel">{{ $blog->is_gallery ? 'গ্যালারিতে যুক্ত' : 'গ্যালারিতে যুক্ত নয়' }}</label>
                                </div>
                                <div class="mb-3" id="galleryOrderSection"
                                    style="{{ $blog->is_gallery ? '' : 'display: none;' }}">
                                    <label class="form-label">গ্যালারি ক্রম (Order)</label>
                                    <input type="number" name="gallery_order" class="form-control"
                                        value="{{ old('gallery_order', $blog->gallery_order ?? 0) }}" min="0">
                                </div>
                                <div class="mb-3">
        ...
        $(document).ready(function() {
            ...
            function initTinyMCE() {
                tinymce.init({
                    ...
                    toolbar: 'formatselect | bold italic | bullist numlist | blockquote | alignleft aligncenter alignright alignjustify | link media | pagebreak | fullscreen',
                    menubar: false,
                    branding: false,
                    height: 450,
                    image_title: true,
            ...
            $('#generateSeoBtn').on('click', function() {
                ...
                btn.prop('disabled', true).html(
                    '<i class="fas fa-spinner fa-spin me-1"></i> জেনারেট হচ্ছে...');
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (response.success) {
                            ...
                            $('#metaDescription').val(response.meta_description).trigger(
                                'input');
                            ...
                            Swal.fire({
                                icon: 'error',
                                title: 'ত্রুটি!',
                                text: 'মেটা ডাটা তৈরি করতে ব্যর্থ হয়েছে: ' + response
                                    .message,
                                confirmButtonColor: '#3085d6',
                                confirmButtonText: 'ঠিক আছে'
                            });
            ...
            // 11. Video Insertion Helpers (YouTube & Facebook)
            ...
            function insertVideoHtml(embedHtml) {
                if (tinymce.get('editor') && !tinymce.get('editor').isHidden()) {
                    tinymce.get('editor').insertContent(embedHtml);
                } else {
                    const textarea = document.getElementById('editor');
            ...
            window.insertYoutubeVideo = function() {
                Swal.fire({
                    title: 'YouTube ভিডিও যুক্ত করুন',
                    text: 'ইউটিউব ভিডিওর লিঙ্ক (URL) অথবা Embed কোড দিন:',
                    input: 'textarea',
                    inputPlaceholder: 'https://www.youtube.com/watch?v=... অথবা https://youtu.be/... অথবা <iframe...>',
                    showCancelButton: true,
                    confirmButtonText: '<i class="fab fa-youtube me-1"></i> যুক্ত করুন',
                    cancelButtonText: 'বাতিল',
                    confirmButtonColor: '#ff0000',
                    inputValidator: (value) => {
                        if (!value) {
                            return 'অনুগ্রহ করে ইউটিউব ভিডিওর লিংক বা কোড দিন!';
                        }
                    }
                }).then((result) => {
                    if (result.isConfirmed && result.value) {
                        var input = result.value.trim();
                        var embedHtml = '';

                        if (input.includes('<iframe')) {
                            embedHtml = input;
                        } else {
                            var isShorts = input.includes('/shorts/');
                            var videoId = extractYoutubeId(input);
                            if (videoId) {
                                if (isShorts) {
                                    embedHtml = `<div class="my-3 text-center" style="width: 100%; max-width: 380px; margin: 1.5rem auto;"><iframe src="https://www.youtube.com/embed/${videoId}" width="380" height="640" style="width:100%;max-width:380px;height:640px;border-radius:12px;border:0;" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>`;
                                } else {
                                    embedHtml = `<div class="ratio ratio-16x9 my-3"><iframe src="https://www.youtube.com/embed/${videoId}" frameborder="0" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen></iframe></div>`;
                                }
                            } else {
                                Swal.fire('ত্রুটি!', 'সঠিক ইউটিউব লিঙ্ক বা কোড পাওয়া যায়নি!', 'error');
                                return;
                            }
                        }
                        insertVideoHtml(embedHtml);
                        Swal.fire({
                            icon: 'success',
                            title: 'সফল!',
                            text: 'YouTube ভিডিও সফলভাবে এডিটরে যোগ করা হয়েছে!',
                            timer: 1500,
            ...
            window.insertFacebookVideo = function() {
                Swal.fire({
                    title: 'Facebook ভিডিও / রিলস যুক্ত করুন',
                    text: 'ফেসবুক ভিডিও বা রিলসের লিঙ্ক (URL) অথবা Embed কোড দিন:',
                    input: 'textarea',
                    inputPlaceholder: 'https://www.facebook.com/reel/... অথবা https://www.facebook.com/.../videos/... অথবা <iframe...>',
                    showCancelButton: true,
                    confirmButtonText: '<i class="fab fa-facebook me-1"></i> যুক্ত করুন',
                    cancelButtonText: 'বাতিল',
                    confirmButtonColor: '#1877f2',
                    inputValidator: (value) => {
                        if (!value) {
                            return 'অনুগ্রহ করে ফেসবুক ভিডিওর লিংক বা কোড দিন!';
                        }
                    }
                }).then((result) => {
                    if (result.isConfirmed && result.value) {
                        ...
                        if (input.includes('<iframe')) {
                            ...
                            embedHtml = `<div class="my-3 text-center" style="width: 100%; max-width: 500px; margin: 1.5rem auto;"><iframe src="https://www.facebook.com/plugins/video.php?href=${encodedUrl}&show_text=true" width="100%" height="680" style="border:none;overflow:hidden;width:100%;max-width:500px;height:680px;border-radius:12px;" scrolling="no" frameborder="0" allowfullscreen="true" allow="autoplay; clipboard-write; encrypted-media; picture-in-picture; web-share"></iframe></div>`;
                        } else {
                            Swal.fire('ত্রুটি!', 'সঠিক ফেসবুক লিঙ্ক বা কোড দিন!', 'error');
                            return;
                        }
                        insertVideoHtml(embedHtml);
                        Swal.fire({
                            icon: 'success',
                            title: 'সফল!',
                            text: 'Facebook ভিডিও সফলভাবে এডিটরে যোগ করা হয়েছে!',
                            timer: 1500,
                            showConfirmButton: false
                        });
                    }
            ...
            $('#insertYoutubeBtn').on('click', function(e) {
                e.preventDefault();
                insertYoutubeVideo();
            });

            $('#insertFbVideoBtn').on('click', function(e) {
                e.preventDefault();
                insertFacebookVideo();
            });
