                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" value="{{ old('title', $blog->title) }}" placeholder="ব্লগ পোস্টের শিরোনাম লিখুন" required>
                                @error('title')
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" value="{{ old('slug', $blog->slug) }}" placeholder="স্লাগ লিখুন (ঐচ্ছিক)">
                                <div class="slug-preview">
                                    <i class="fas fa-link me-1"></i>
                                    পোস্ট URL: <span class="slug-text" id="slugPreview">{{ url('/blog') }}/{{ $blog->slug }}</span>
                                </div>
                                @error('slug')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="short_description" id="shortDescription" class="form-control @error('short_description') is-invalid @enderror" rows="3" placeholder="ব্লগ পোস্টের সংক্ষিপ্ত বিবরণ লিখুন (৫০০ অক্ষরের মধ্যে)">{{ old('short_description', $blog->short_description) }}</textarea>
                                <div class="d-flex justify-content-end mt-1">
                                    <span class="text-muted small" id="descCount">{{ strlen(old('short_description', $blog->short_description)) }}/500</span>
                                </div>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="wp-editor-wrap">
                                    ...
                                    <div class="wp-editor-container">
                                        <textarea name="content" id="editor" class="form-control @error('content') is-invalid @enderror" placeholder="ব্লগ পোস্টের সম্পূর্ণ কন্টেন্ট লিখুন..." style="height: 450px;">{{ old('content', $blog->content) }}</textarea>
                                    </div>
                                </div>
                                @error('content')
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="meta_title" id="metaTitle" class="form-control @error('meta_title') is-invalid @enderror" value="{{ old('meta_title', $blog->meta_title) }}" placeholder="SEO টাইটেল লিখুন (৬০ অক্ষরের মধ্যে)">
                                <div class="d-flex justify-content-end mt-1">
                            ...
                            <div class="mb-3">
                                ...
                                <textarea name="meta_description" id="metaDescription" class="form-control @error('meta_description') is-invalid @enderror" rows="2" placeholder="SEO ডেসক্রিপশন লিখুন (১৬০ অক্ষরের মধ্যে)">{{ old('meta_description', $blog->meta_description) }}</textarea>
                                <div class="d-flex justify-content-end mt-1">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="text" name="meta_keywords" id="metaKeywords" class="form-control @error('meta_keywords') is-invalid @enderror" value="{{ old('meta_keywords', $blog->meta_keywords) }}" placeholder="কীওয়ার্ডগুলো কমা (,) দিয়ে আলাদা করুন">
                                @error('meta_keywords')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            </div>
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-section">
                            ...
                            <div class="text-center">
                                <div class="image-preview-container">
                                    <img src="{{ $blog->featured_image ? asset($blog->featured_image) : asset('images/default-blog.jpg') }}" alt="Featured Image" class="image-preview" id="imagePreview">
                        ...
                        <div class="form-section">
                            ...
                            <select name="tags[]" id="tagSelect" class="form-select select2" multiple="multiple" style="width: 100%;">
                                @foreach($tags as $tagString)
                                    <option value="{{ $tagString }}" {{ in_array($tagString, old('tags', $blog->tags ?? [])) ? 'selected' : '' }}>
                                        {{ $tagString }}
                                    </option>
                                @endforeach
                            </select>
                        ...
                        <div class="form-section">
                            ...
                            <div class="mb-3 form-check form-switch">
                                ...
                                <input type="checkbox" name="status" id="statusSwitch" class="form-check-input" value="1" {{ old('status', $blog->status) ? 'checked' : '' }}>
                                <label for="statusSwitch" class="form-check-label" id="statusLabel">{{ $blog->status ? 'প্রকাশিত' : 'খসড়া' }}</label>
                            </div>
                            <div class="mb-3 form-check form-switch">
                                <input type="hidden" name="is_gallery" value="0">
                                <input type="checkbox" name="is_gallery" id="isGallerySwitch" class="form-check-input" value="1" {{ old('is_gallery', $blog->is_gallery) ? 'checked' : '' }}>
                                <label for="isGallerySwitch" class="form-check-label" id="galleryLabel">{{ $blog->is_gallery ? 'গ্যালারিতে যুক্ত' : 'গ্যালারিতে যুক্ত নয়' }}</label>
                            </div>
                            <div class="mb-3" id="galleryOrderSection" style="{{ $blog->is_gallery ? '' : 'display: none;' }}">
                                <label class="form-label">গ্যালারি ক্রম (Order)</label>
                                <input type="number" name="gallery_order" class="form-control" value="{{ old('gallery_order', $blog->gallery_order ?? 0) }}" min="0">
                            </div>
                            <div class="mb-3">
