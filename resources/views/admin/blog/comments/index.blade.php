...
@section('page-title', 'Blog Comment Management')
        ...
        <div class="card-body p-3">
            <div class="row g-2">
                <div class="col-md-3 col-sm-6">
                    <input type="text" id="search-input" class="form-control" placeholder="নাম, ইমেইল, মন্তব্য খুঁজুন..."
            ...
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    <span class="badge bg-primary ms-2"
                        id="total-count">{{ $comments->total() ?? $comments->count() }}</span>
                </h3>
                <div class="card-tools">
                    <div class="btn-group">
                        <a href="{{ route('admin.blog.comments.export', request()->query()) }}"
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-success"><small>✅ অ্যাপ্রুভ করলে প্যারেন্ট কমেন্টও অ্যাপ্রুভ হবে (যদি প্রয়োজন
                            হয়)</small></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">বাতিল</button>
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-danger"><small>⚠️ এই কাজটি অপরিবর্তনীয়! সব পেন্ডিং মন্তব্য ও তাদের রিপ্লাই মুছে
                            যাবে।</small></p>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">বাতিল</button>
                    ...
                    Swal.fire({
                        ...
                        if (result.isConfirmed) {
                            $.ajax({
                                ...
                                error: function() {
                                    toastr.error(
                                        'মন্তব্য ডিসঅ্যাপ্রুভ করতে ব্যর্থ হয়েছে');
                                }
                            });
                        }
                    });
                ...
                $('#delete-pending-btn').off('click').on('click', function() {
                    ...
                    $('#confirm-delete-pending').off('click').on('click', function() {
                        $.ajax({
                            ...
                            error: function() {
                                toastr.error(
                                'পেন্ডিং মন্তব্য মুছে ফেলতে ব্যর্থ হয়েছে');
                                $('#deletePendingModal').modal('hide');
                            }
                        });
                    });
