        ...
        <div class="card-body p-2">
            <div class="row g-2">
                <div class="col-md-3 col-sm-6">
                    <input type="text" id="search-input" class="form-control" placeholder="ক্যাটাগরি খুঁজুন..."
            ...
            <div class="card-header">
                <h3 class="card-title">
                    ...
                    <span class="badge bg-primary ms-2"
                        id="total-count">{{ $categories->total() ?? $categories->count() }}</span>
                </h3>
                <div class="card-tools">
                    <div class="btn-group">
                        ...
                        <a href="{{ route('admin.blog.categories.export', request()->query()) }}"
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="text-warning" id="delete-blog-warning" style="display: none;">
                        ...
                        এই ক্যাটাগরির অধীনে <strong id="delete-blog-count"></strong> টি ব্লগ পোস্ট আছে। প্রথমে ব্লগ পোস্ট
                        গুলো সরান বা অন্য ক্যাটাগরিতে স্থানান্তর করুন!
                    </div>
                </div>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <p class="text-warning" id="bulk-delete-warning" style="display: none;">
                        <i class="fas fa-exclamation-triangle"></i>
                        কিছু ক্যাটাগরির অধীনে ব্লগ পোস্ট আছে। প্রথমে ব্লগ পোস্ট গুলো সরান বা অন্য ক্যাটাগরিতে স্থানান্তর
                        করুন!
                    </p>
                </div>
                <div class="modal-footer">
