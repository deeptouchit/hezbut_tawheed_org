    ...
    <div class="row px-3">
        <div class="col-md-6 mb-3">
            <div class="input-group">
                ...
                <input type="text" id="search-input" class="form-control" placeholder="শিরোনাম, স্ল্যাগ বা বিবরণ..."
                    autocomplete="off">
            </div>
        </div>
    ...
    <div class="container-fluid">
        <div class="card">
            <div class="card-header">
                <h3 class="card-title">
                    <i class="fas fa-list-check me-2"></i> কার্যক্রম তালিকা
                    <span class="badge bg-primary ms-2"
                        id="total-count">{{ $activities->total() ?? $activities->count() }}</span>
                </h3>
                <div class="card-tools">
                    <div class="btn-group">
                        <a href="{{ route('admin.activities.create') }}" class="btn btn-primary btn-sm">
                            <i class="fas fa-plus"></i> নতুন কার্যক্রম যোগ করুন
                        </a>
                    </div>
                </div>
            </div>
            ...
            <div class="card-body p-0">
                ...
                <div class="row g-3 p-3 bg-light border-bottom">
                    <div class="col-md-4 col-sm-6">
                        <div
                            class="d-flex align-items-center bg-white p-3 rounded shadow-sm border-start border-3 border-info">
                            <div class="fs-2 text-info me-3"><i class="fas fa-list-check"></i></div>
                            <div>
                                <span class="text-muted small">মোট কার্যক্রম</span>
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div
                            class="d-flex align-items-center bg-white p-3 rounded shadow-sm border-start border-3 border-success">
                    ...
                    <div class="col-md-4 col-sm-6">
                        <div
                            class="d-flex align-items-center bg-white p-3 rounded shadow-sm border-start border-3 border-danger">
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header bg-danger text-white">
                    <h5 class="modal-title" id="deleteModalLabel">কার্যক্রম ডিলিট কনফার্মেশন</h5>
                    <button type="button" class="btn-close btn-close-white" data-bs-dismiss="modal"
                        aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <p>আপনি কি নিশ্চিত যে আপনি '<strong id="delete-item-name"></strong>' কার্যক্রমটি ডিলিট করতে চান?</p>
                    <p class="text-danger small mb-0"><i class="fas fa-exclamation-triangle"></i> এই ফাইল ও ডাটা ডিলিট হলে
                        আর ফেরত আনা যাবে না!</p>
                </div>
        ...
        $(document).ready(function() {
            ...
            function attachEventHandlers() {
                ...
                $('.toggle-status').off('click').on('click', function() {
                    ...
                    $.ajax({
                        url: '{{ url('admin/activities') }}/' + id + '/toggle-status',
                        type: 'POST',
                        data: {
                            _token: '{{ csrf_token() }}'
                        },
                ...
                $('.delete-activity').off('click').on('click', function() {
                    ...
                    $('#confirm-delete').off('click').on('click', function() {
                        $.ajax({
                            ...
                            error: function() {
                                $('#deleteModal').modal('hide');
                                toastr.error('কার্যক্রম ডিলিট করতে ব্যর্থ হয়েছে');
                            }
                        });
                    });
                });
