...
@section('page-title', 'নতুন কার্যক্রম যোগ করুন')
...
<div class="container-fluid">
    <div class="row">
        <div class="col-lg-12">
            <form action="{{ route('admin.activities.store') }}" method="POST" id="activityForm" enctype="multipart/form-data">
                @csrf
                <div class="row">
                        ...
                        <div class="card card-outline card-success shadow-sm mb-4">
                            <div class="card-body">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="title" id="title" class="form-control @error('title') is-invalid @enderror" placeholder="যেমন: ফ্রি রক্তদান কর্মসূচি, উগ্রবাদ বিরোধী সেমিনার" value="{{ old('title') }}" required>
                                    @error('title')
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="slug" id="slug" class="form-control @error('slug') is-invalid @enderror" placeholder="যেমন: free-blood-donation" value="{{ old('slug') }}" required>
                                    <small class="text-muted">ইউআরএল হবে: <span class="fw-bold" id="slugPreview">{{ url('/activities') }}/[slug]</span></small>
                                    @error('slug')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                                ...
                                <div class="mb-3">
                                    ...
                                    <textarea name="description" id="description" class="form-control @error('description') is-invalid @enderror" rows="3" placeholder="কার্যক্রমের একটি আকর্ষণীয় সংক্ষিপ্ত বিবরণী এখানে লিখুন...">{{ old('description') }}</textarea>
                                    @error('description')
                                        <div class="invalid-feedback">{{ $message }}</div>
                                    @enderror
                                </div>
                    ...
                    <div class="col-md-3">
                        ...
                        <div class="form-section shadow-sm bg-white border border-light">
                            ...
                            <button type="submit" class="btn btn-success w-100 mb-2">
                                <i class="fas fa-save me-1"></i> কার্যক্রম সংরক্ষণ করুন
                            </button>
                        ...
                        <div class="form-section shadow-sm bg-white border border-light">
                            ...
                            <div class="image-preview-container">
                                <img src="https://placehold.co/600x400/e9ecef/adb5bd?text=No+Image+Selected" id="imagePreview" class="image-preview" alt="Preview">
                            </div>
                            
                            <div class="mb-3">
                                <label for="imageInput" class="form-label small fw-bold">ছবি নির্বাচন করুন</label>
