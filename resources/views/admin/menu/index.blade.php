       ...
       ========================================================================== --}}
        <div class="menu-selection-bar shadow-sm">
            <div class="d-flex align-items-center">
                <label for="menuSelect"><i class="fas fa-edit text-success me-1"></i> সম্পাদনার জন্য মেনু নির্বাচন
                    করুন:</label>
        ...
        <div class="menu-container">
           ...
           ========================== --}}
            <div class="menu-sidebar">
                <h5 class="fw-bold mb-3 text-secondary" style="font-size: 15px;"><i
                        class="fas fa-plus-circle text-success me-1"></i> মেনু আইটেম যোগ করুন</h5>
                    ...
                    <div class="accordion-content-custom">
                        <div class="checkbox-list-scroll">
                            <label class="checkbox-item">
                                <input type="checkbox" class="page-checkbox" data-name="হোমপেজ" data-url="/"
                                    data-type="route" data-icon="fas fa-home">
                                হোমপেজ (/)
                            </label>
                            <label class="checkbox-item">
                                <input type="checkbox" class="page-checkbox" data-name="আমাদের সম্পর্কে" data-url="about"
                                    data-type="route" data-icon="fas fa-info-circle">
                                আমাদের সম্পর্কে (/about)
                            </label>
                            <label class="checkbox-item">
                                <input type="checkbox" class="page-checkbox" data-name="ব্লগ" data-url="blog"
                                    data-type="route" data-icon="fas fa-newspaper">
                                ব্লগ (/blog)
                            </label>
                            <label class="checkbox-item">
                                <input type="checkbox" class="page-checkbox" data-name="যোগাযোগ" data-url="contact"
                                    data-type="route" data-icon="fas fa-envelope">
                                যোগাযোগ (/contact)
                            </label>
                            <label class="checkbox-item">
                                <input type="checkbox" class="page-checkbox" data-name="প্রাইভেসি পলিসি" data-url="privacy"
                                    data-type="route" data-icon="fas fa-shield-alt">
                                প্রাইভেসি পলিসি (/privacy)
                            </label>
                            <label class="checkbox-item">
                                <input type="checkbox" class="page-checkbox" data-name="শর্তাবলী" data-url="terms"
                                    data-type="route" data-icon="fas fa-gavel">
                                শর্তাবলী (/terms)
                            </label>
                        </div>
                    ...
                    <div class="accordion-content-custom">
                        ...
                        <div class="checkbox-list-scroll category-list-container">
                            @forelse($categories as $category)
                                <label class="checkbox-item category-item-row"
                                    data-search-name="{{ strtolower($category->name) }}">
                                    <input type="checkbox" class="category-checkbox" data-name="{{ $category->name }}"
                                        data-url="blog.category" data-type="route" data-icon="fas fa-tag"
                    ...
                    <div class="accordion-content-custom">
                        <div class="mb-2">
                            <label class="form-label"
                                style="font-size: 11px; font-weight: bold; margin-bottom: 2px;">ইউআরএল (URL):</label>
                            <input type="text" id="customUrl" class="form-control form-control-sm"
                                placeholder="https://example.com বা /custom-path">
                        </div>
                        <div class="mb-2">
                            <label class="form-label" style="font-size: 11px; font-weight: bold; margin-bottom: 2px;">লিংক
                                টেক্সট (Label):</label>
                            <input type="text" id="customLabel" class="form-control form-control-sm"
                                placeholder="মেনু আইটেমের নাম">
                        </div>
                        <div class="mb-3">
                            <label class="form-label" style="font-size: 11px; font-weight: bold; margin-bottom: 2px;">আইকন
                                ক্লাস (Icon):</label>
                            <input type="text" id="customIcon" class="form-control form-control-sm"
                                placeholder="fas fa-link (ঐচ্ছিক)">
                        </div>
           ...
           ========================== --}}
            <div class="menu-editor-panel shadow-sm">
                ...
                <div class="panel-body-custom">
                    <p class="text-muted"
                        style="font-size: 13px; border-left: 3px solid #017e3d; padding-left: 10px; margin-bottom: 20px;">
                        বাম পাশ থেকে আইটেম সিলেক্ট করে মেনুতে যুক্ত করুন। এরপর আইটেমগুলোকে উপরে-নিচে টেনে নিয়ে আপনার
                        পছন্দমতো ক্রমানুসারে সাজান। আইটেমের ডান পাশের অ্যারো আইকনে ক্লিক করে আইকন ও নাম এডিট করতে পারবেন।
                    </p>
        ...
        $(document).ready(function() {
            ...
            function populateParentDropdowns() {
                ...
                $('#menuItemsList .menu-item-card').each(function() {
                    let id = $(this).attr('id');
                    let name = $(this).find('.item-label-input').val() || $(this).find(
                        '.menu-item-title-text').text();
                    allItems.push({
                        id: id,
                        name: name.trim()
                    });
                ...
                if ($.fn.sortable) {
                    listContainer.sortable({
                        ...
                        stop: function(event, ui) {
                            ...
                            if (relativeLeft >= 20) {
                                let preceding = ui.item.prevAll('.menu-item-card:not(.nested-item)')
                                    .first();
                ...
                Swal.fire({
                    ...
                    if (result.isConfirmed) {
                        ...
                        desktopItems.forEach(function(item) {
                            ...
                            newItem.id = 'menu_' + Date.now() + '_' + Math.floor(Math
                                .random() * 10000);
                        ...
                        $('#menuEmptyState').hide();
                        toastr.success(
                            'ডেস্কটপ মেনু থেকে সফলভাবে কপি করা হয়েছে! স্থায়ীভাবে সংরক্ষণ করতে "মেনু সংরক্ষণ করুন" বাটনটি ক্লিক করুন।'
                            );
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        ...
                        let errorMsg = xhr.responseJSON?.message ||
                            'মেনু সংরক্ষণ করতে সমস্যা হয়েছে';
