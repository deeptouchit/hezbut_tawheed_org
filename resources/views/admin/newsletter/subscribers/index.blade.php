                    ...
                    <div class="card-body">
                        <div class="d-flex justify-content-between align-items-center">
                            <div>
                                ...
                                <h5 class="mb-0 fw-bold metric-number">
                                    {{ number_format($stats['total'] - $stats['verified']) }}</h5>
                            </div>
        ...
        <div class="card">
            ...
            <div class="card-body p-0">
                ...
                <div id="subscribers-table-container">
                    @include('admin.newsletter.subscribers.partials.table', [
                    ...
                    <form id="addSubscriberForm">
                        ...
                        <div class="form-group">
                            ...
                            <input type="text" name="name" id="name" class="form-control"
                                placeholder="সাবস্ক্রাইবারের নাম">
                    ...
                    success: function(response) {
                        if (response.success && response.html) {
                            ...
                            if (response.stats) {
                                ...
                                $('.metric-number').eq(3).text(response.stats.total - response.stats
                                    .verified);
                            }
                ...
                $.ajax({
                    ...
                    error: function(xhr) {
                        var error = xhr.responseJSON?.message ||
                            'সাবস্ক্রাইবার যোগ করতে ব্যর্থ হয়েছে';
                        toastr.error(error);
                    },
                    complete: function() {
