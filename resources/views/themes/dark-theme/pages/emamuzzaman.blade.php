        ...
        <div class="container">
            <div class="row align-items-center mb-5">
                <div class="col-lg-4 text-center mb-4 mb-lg-0">
                    <div class="hover-zoom shadow rounded-4 overflow-hidden p-3 border" style="background-color: #1f2937; border-color: #374151 !important;">
                ...
                <div class="col-lg-8 ps-lg-5">
                    <h2 class="fw-bold mb-4" style="color: #10B981; font-family: 'Baloo Da 2', sans-serif;">প্রতিষ্ঠাতা এমামুয্যামান মোহাম্মদ বায়াজীদ খান পন্নী</h2>
                    ...
                    <blockquote class="blockquote border-start border-5 border-success ps-4 py-2 rounded-3 shadow-sm mb-0" style="background-color: #1f2937;">
                        <p class="mb-0 text-white italic fw-semibold" style="font-size: 1.05rem; line-height: 1.7;">
            ...
            <div class="card p-4 p-md-5 border-0 shadow-sm rounded-4 mt-5" style="background-color: #1f2937; border: 1px solid #374151 !important;">
                <h3 class="mb-4 text-center fw-bold" style="color: #10B981; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-book me-2"></i> এমামুয্যামানের কালজয়ী প্রকাশনাসমূহ</h3>
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="card h-100 border p-4 rounded-3 hover-lift" style="transition: all 0.3s ease; background-color: #111827; border-color: #374151 !important;">
                            <div class="text-success mb-3"><i class="fas fa-book-open fa-2x"></i></div>
                            <h5 class="fw-bold mb-2 text-white">হেযবুত তওহীদ (আন্দোলনের রূপরেখা)</h5>
                            <p class="text-light opacity-75 mb-0 small" style="line-height: 1.6;">
                    ...
                    <div class="col-md-6">
                        <div class="card h-100 border p-4 rounded-3 hover-lift" style="transition: all 0.3s ease; background-color: #111827; border-color: #374151 !important;">
                            <div class="text-success mb-3"><i class="fas fa-book-open fa-2x"></i></div>
                            <h5 class="fw-bold mb-2 text-white">ইসলামের প্রকৃত রূপরেখা</h5>
                            <p class="text-light opacity-75 mb-0 small" style="line-height: 1.6;">
                    ...
                    <div class="col-md-6">
                        <div class="card h-100 border p-4 rounded-3 hover-lift" style="transition: all 0.3s ease; background-color: #111827; border-color: #374151 !important;">
                            <div class="text-success mb-3"><i class="fas fa-book-open fa-2x"></i></div>
                            <h5 class="fw-bold mb-2 text-white">দাজ্জাল? ইহুদি-খ্রিষ্টান ‘সভ্যতা’!</h5>
                            <p class="text-light opacity-75 mb-0 small" style="line-height: 1.6;">
                    ...
                    <div class="col-md-6">
                        <div class="card h-100 border p-4 rounded-3 hover-lift" style="transition: all 0.3s ease; background-color: #111827; border-color: #374151 !important;">
                            <div class="text-success mb-3"><i class="fas fa-book-open fa-2x"></i></div>
                            <h5 class="fw-bold mb-2 text-white">জেহাদ, কেতাল ও সন্ত্রাস</h5>
                            <p class="text-light opacity-75 mb-0 small" style="line-height: 1.6;">
