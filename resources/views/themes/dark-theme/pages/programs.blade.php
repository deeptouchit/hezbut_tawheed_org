...
<style>
    /* ============================================================
       VERBATIM EDITORIAL STEPPER - PROGRAMS PAGE (DARK THEME)
       ============================================================ */
    .prog-section {
    ...
    <section class="prog-section">
        <div class="container">
            ...
            <div class="text-center mb-5">
                <h2 class="fw-bold mb-3" style="color: #f8fafc; font-size: 2.2rem;">আল্লাহর দেয়া এই ৫ দফা কমসূচির ব্যাখ্যা:</h2>
            ...
            <div class="stepper-container">
                ...
                <div class="step-panel-wrapper">
                    ...
                    <div class="step-panel">
                        <div class="panel-grid">
                            <div class="panel-details">
                                <h3><i class="fas fa-sign-out-alt"></i> চতুর্থ দায়িত্ব – হিজরত</h3>
                                <div class="panel-text">
                                    <p>
