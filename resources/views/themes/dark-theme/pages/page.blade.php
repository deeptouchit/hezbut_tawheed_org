...
@section('content')
                        ...
                        <article class="page-body text-start text-dark lh-lg">
                            ...
                            @if($page->slug === 'about-us' && isset($teamMembers) && count($teamMembers) > 0)
                                ...
                                <div class="mt-5 pt-5 border-top">
                                    <h3 class="mb-5 text-center fw-bold" style="color: #10B981; font-size: 2rem;">কেন্দ্রীয় কার্যনির্বাহী কমিটি</h3>
                                    <div class="row g-4 justify-content-center">
                                        @foreach($teamMembers as $member)
                                            <div class="col-lg-4 col-md-6 col-sm-10">
                                                <div class="card text-center border shadow-sm rounded-4 overflow-hidden h-100 bg-white" style="transition: all 0.3s ease; background-color: #1f2937 !important;">
                                                    ...
                                                    <div class="card-body p-4">
                                                        <h5 class="fw-bold text-white mb-2" style="font-size: 1.25rem;">{{ $member->name }}</h5>
    ...
    <style>
        ...
        .page-body .card:not(.text-center) {
            border: none !important;
            box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.05), 0 2px 4px -1px rgba(0, 0, 0, 0.03) !important;
            transition: transform 0.2s ease, box-shadow 0.2s ease;
        }
        .page-body .card:not(.text-center):hover {
