            ...
            <div class="row">
                ...
                <div class="col-lg-8">
                    ...
                    @if(request()->filled('search') || request()->filled('category') || request()->filled('tag'))
                        <div class="bg-slate-800 p-3 rounded-3 shadow-sm border border-slate-700 mb-4 d-flex justify-content-between align-items-center" style="font-family: 'Baloo Da 2', sans-serif; font-size: 0.92rem; background-color: #1e293b; border: 1px solid #334155;">
                            <span class="text-slate-300" style="color: #cbd5e1;">
                                ফিল্টারিং রেজাল্ট: 
                                @if(request()->filled('search'))
                                    সার্চ কীওয়ার্ড: <strong class="text-white" style="color: #ffffff;">"{{ request('search') }}"</strong>
                                @endif
                                @if(request()->filled('category'))
                                    ক্যাটাগরি: <strong class="text-success" style="color: #ef4444;">"{{ request('category') }}"</strong>
                                @endif
                                @if(request()->filled('tag'))
                                    ট্যাগ: <strong class="text-primary" style="color: #3b82f6;">"#{{ request('tag') }}"</strong>
                                @endif
                            </span>
                    ...
                    <div class="row g-4">
                        ...
                        @empty
                            <div class="col-12 text-center py-5 rounded-4 shadow-sm border" style="background-color: #1e293b; border-color: #334155 !important;">
                                ...
                                <h4 class="text-white fw-bold" style="font-family: 'Baloo Da 2', sans-serif;">দুঃখিত, কোনো নিবন্ধ খুঁজে পাওয়া যায়নি!</h4>
                                <p class="small" style="color: #cbd5e1;">দয়া করে অন্য কোনো কীওয়ার্ড ব্যবহার করে সার্চ করুন বা সম্পূর্ণ সংবাদের লিস্ট দেখুন।</p>
                                <a href="{{ route('blog') }}" class="btn btn-danger rounded-pill fw-bold px-4 py-2 mt-2" style="font-family: 'Baloo Da 2', sans-serif; font-size: 13px;">সকল নিবন্ধ</a>
                            </div>
                        @endforelse
                    </div>
                    ...
                    <div class="ps-lg-2">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 p-4 mb-4" style="background-color: #1e293b; border: 1px solid #334155 !important;">
                            ...
                            <form action="{{ route('blog') }}" method="GET" class="search-form-sidebar">
                                ...
                                @endif
                                <div class="input-group border rounded-pill overflow-hidden p-0.5" id="search-wrapper" style="background-color: #0f172a; border-color: #334155 !important;">
                                    <input type="text" name="search" class="form-control border-0 py-2 ps-3 pe-1 text-white" 
                                           placeholder="কীওয়ার্ড লিখুন..." value="{{ request('search') }}" style="font-size: 0.9rem; box-shadow: none; font-family: 'Baloo Da 2', sans-serif; background-color: transparent;">
                                    <button type="submit" class="btn btn-danger rounded-circle d-flex align-items-center justify-content-center" style="width: 36px; height: 36px; padding: 0; background-color: #ef4444;"><i class="fas fa-search"></i></button>
                                </div>
                            </form>
                        </div>
