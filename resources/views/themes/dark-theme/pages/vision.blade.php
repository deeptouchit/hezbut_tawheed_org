...
<style>
    /* ============================================================
       VISION SECTION - Clean, Premium Color Combination & Sharp (Dark)
       ============================================================ */
    .vision-section {
        background: #0b0f19;
        position: relative;
    ...
    .vision-tab-btn.active {
        background: #1e293b; /* Dark Active Background */
        color: #ffffff; /* Active Text */
        border-left-color: #ffffff; /* Active left bar */
        font-weight: 700;
    }
                        ...
                        <div class="vision-content-pane">
                            ...
                            <div id="tab-structure" class="vision-panel active" role="tabpanel">
                                <div class="panel-header">
                                    ...
                                    <span style="font-size:0.7rem; color:#94a3b8; font-weight:700; letter-spacing:0.04em;">সাংগঠনিক কাঠামো</span>
                                </div>
                            ...
                            <div id="tab-goals" class="vision-panel" role="tabpanel">
                                <div class="panel-header">
                                    ...
                                    <span style="font-size:0.7rem; color:#94a3b8; font-weight:700; letter-spacing:0.04em;">লক্ষ্য ও উদ্দেশ্য</span>
                                </div>
                                <div class="panel-core-statement">
                                    <i class="fas fa-quote-right quote-icon"></i>
                            ...
                            <div id="tab-women" class="vision-panel" role="tabpanel">
                                <div class="panel-header">
                                    ...
                                    <span style="font-size:0.7rem; color:#94a3b8; font-weight:700; letter-spacing:0.04em;">নারী অধিকার ও মর্যাদা</span>
                                </div>
                                <div class="panel-core-statement">
                                    <i class="fas fa-quote-right quote-icon"></i>
                            ...
                            <div id="tab-extremism" class="vision-panel" role="tabpanel">
                                <div class="panel-header">
                                    ...
                                    <span style="font-size:0.7rem; color:#94a3b8; font-weight:700; letter-spacing:0.04em;">জঙ্গিবাদ ও উগ্রবাদ প্রতিবাদ</span>
                                </div>
                                <div class="panel-core-statement">
                                    <i class="fas fa-quote-right quote-icon"></i>
                            ...
                            <div id="tab-harmony" class="vision-panel" role="tabpanel">
                                <div class="panel-header">
                                    ...
                                    <span style="font-size:0.7rem; color:#94a3b8; font-weight:700; letter-spacing:0.04em;">সাম্প্রদায়িক সম্প্রীতি</span>
                                </div>
                                <div class="panel-core-statement">
                                    <i class="fas fa-quote-right quote-icon"></i>
                            ...
                            <div id="tab-law" class="vision-panel" role="tabpanel">
                                <div class="panel-header">
                                    ...
                                    <span style="font-size:0.7rem; color:#94a3b8; font-weight:700; letter-spacing:0.04em;">আইন ও দেশের সংবিধান</span>
                                </div>
                                <div class="panel-core-statement">
                                    <i class="fas fa-quote-right quote-icon"></i>
                            ...
                            <div id="tab-finance" class="vision-panel" role="tabpanel">
                                <div class="panel-header">
                                    ...
                                    <span style="font-size:0.7rem; color:#94a3b8; font-weight:700; letter-spacing:0.04em;">অর্থায়ন ও তহবিল</span>
                                </div>
                                <div class="panel-core-statement">
                                    <i class="fas fa-quote-right quote-icon"></i>
                            ...
                            <div id="tab-revival" class="vision-panel" role="tabpanel">
                                <div class="panel-header">
                                    ...
                                    <span style="font-size:0.7rem; color:#94a3b8; font-weight:700; letter-spacing:0.04em;">কোর’আন ও সুন্নাহ</span>
                                </div>
                                <div class="panel-core-statement">
                                    <i class="fas fa-quote-right quote-icon"></i>
