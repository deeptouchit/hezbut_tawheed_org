...
<style>
    /* ============================================================
       RESEARCH & DEVELOPMENT PAGE DESIGN (DARK THEME)
       ============================================================ */
    .research-section {
        background: #0f172a;
        padding: 5rem 0 6rem;
    ...
    .book-item-card:hover .book-btn-link {
        color: #93c5fd;
    }
    ...
    .article-post-card:hover .post-card-link {
        color: #93c5fd;
    }
        ...
        <div class="container">
            ...
            <div class="research-grid">
                ...
                <div class="research-visual-card">
                    <h3 class="fw-bold mb-3" style="color: #f8fafc; font-size: 1.4rem;">সত্যের আলোর সন্ধানে গবেষণা</h3>
                    <p class="text-secondary mb-4" style="font-size: 0.98rem; line-height: 1.6; font-weight: 500; color: #94a3b8 !important;">
                        ভুল ব্যাখ্যা নিরসন ও সঠিক জ্ঞান বিস্তারের মাধ্যমে একটি বৈষম্যহীন ও ভারসাম্যপূর্ণ সমাজ গঠন আমাদের অঙ্গীকার।
                    </p>
                    <ul class="list-unstyled p-0 m-0" style="font-weight: 600; color: #cbd5e1;">
            ...
            <div class="projects-container pt-5 border-top">
                ...
                <p class="text-center text-secondary mx-auto mb-5 max-w-800" style="font-size: 1.15rem; line-height: 1.75; font-weight: 500; max-width: 850px;">
                    বাংলাদেশের মতো একটি কৃষিপ্রধান দেশে প্রকৃত অর্থনৈতিক ক্ষমতায়ন ও খাদ্য নিরাপত্তা কৃষক্ষেত্রে একটি বিপ্লবের মাধ্যমেই শুরু হতে হবে। এই বিপ্লব পতিত জমিকে সুযোগ ও আত্মনির্ভরশীলতার উর্বর ভূমিতে রূপান্তরিত করেছে।
                </p>
