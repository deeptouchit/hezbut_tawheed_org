...
@section('title', 'অনুষ্ঠান ও কর্মসূচি - হেজবুত তওহীদ')

@section('content')

    @include('theme::partials.hero_banner', [
        'title' => 'অনুষ্ঠান ও কর্মসূচি',
        'subtitle' => 'সারাদেশে আয়োজিত হেযবুত তওহীদের জনসভা, আলোচনা সভা, সেমিনার ও বিভিন্ন কর্মসূচিসমূহ',
        'badge_text' => 'আন্দোলনের কর্মসূচি ও অনুষ্ঠান',
                    ...
                    <div class="row g-4">
                        ...
                        @empty
                            <div class="col-12 text-center py-5 rounded-4 shadow-sm border" style="background-color: #1e293b; border-color: #334155 !important;">
                                ...
                                <h4 class="text-white fw-bold" style="font-family: 'Baloo Da 2', sans-serif;">দুঃখিত, কোনো কর্মসূচি বা অনুষ্ঠান খুঁজে পাওয়া যায়নি!</h4>
                                <p class="small" style="color: #cbd5e1;">বর্তমানে কোনো কর্মসূচি বা অনুষ্ঠান প্রকাশ করা হয়নি।</p>
                            </div>
                        @endforelse
                    </div>
