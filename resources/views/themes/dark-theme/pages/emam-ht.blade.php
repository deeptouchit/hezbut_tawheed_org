        ...
        <div class="container">
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-8 ps-lg-5">
                    <h2 class="fw-bold mb-4" style="color: #10B981; font-family: 'Baloo Da 2', sans-serif;">বর্তমান এমাম হোসাইন মোহাম্মদ সেলিম</h2>
            ...
            <div class="card p-4 p-md-5 border-0 shadow-sm rounded-4 mt-5" style="background-color: #1f2937; border: 1px solid #374151 !important;">
                <h3 class="mb-4 text-center fw-bold" style="color: #10B981; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-bullseye me-2"></i> সংস্কারমূলক কার্যক্রম ও লক্ষ্য</h3>
                <div class="row g-4">
                    <div class="col-md-6">
                        <div class="p-3 border-start border-success border-4 rounded-3 shadow-sm h-100" style="background-color: #111827; border-color: #064e3b !important; color: #f3f4f6;">
                    ...
                    <div class="col-md-6">
                        <div class="p-3 border-start border-success border-4 rounded-3 shadow-sm h-100" style="background-color: #111827; border-color: #064e3b !important; color: #f3f4f6;">
                            <h5 class="fw-bold text-success">Youth Development & Sports</h5>
                            <p class="text-light opacity-75 small mb-0" style="line-height: 1.6;">
                                যুবসমাজকে ইতিবাচক কাজে নিয়োজিত করতে তিনি নানা উদ্ভাবনী উদ্যোগ ও তরুণদের শরীরচর্চা এবং খেলাধুলায় উদ্বুদ্ধ করার কর্মসূচি গ্রহণ করেছেন।
                            </p>
                        </div>
                    </div>
                </div>
