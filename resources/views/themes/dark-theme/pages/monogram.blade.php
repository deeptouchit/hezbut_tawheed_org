...
<style>
    ...
    .ht-monogram-text {
        ...
        color: #cbd5e1 !important; /* High contrast off-white for dark mode */
    ...
    .ht-monogram-title {
        font-family: 'Baloo Da 2', 'Hind Siliguri', 'Outfit', sans-serif !important;
        color: #10b981 !important; /* Sharp vibrant green */
...
@section('content')
    ...
    <section class="py-5 ht-monogram-section page-body">
        <div class="container">
            <!-- Intro Section -->
            <div class="row align-items-center mb-5">
                <div class="col-lg-5 text-center mb-4 mb-lg-0">
                    <div class="hover-zoom d-inline-flex align-items-center justify-content-center bg-dark p-3 rounded shadow" style="border: 2px solid #10b981;">
                        <img src="{{ asset('uploads/monogram.png') }}" alt="হেযবুত তওহীদের প্রতীক" class="img-fluid" style="max-height: 350px;">
                    </div>
                    <div class="mt-4">
                        <h4 class="fw-bold text-success" style="font-family: 'Baloo Da 2', sans-serif;">অফিশিয়াল মনোগ্রাম</h4>
                        <p class="text-muted small">ঐক্য, শৃঙ্খলা ও সংগ্রামের প্রতীক</p>
                    </div>
                </div>
            ...
            <div class="mt-5">
                ...
                <div class="row g-4">
                    <!-- Element 1: কাবা -->
                    <div class="col-lg-6">
                        <div class="p-4 ht-monogram-card rounded-3 border-start border-success border-5 h-100">
                            <div class="d-flex align-items-center gap-3 mb-3">
                                <div class="bg-success bg-opacity-10 text-success rounded-circle p-3 d-flex align-items-center justify-content-center" style="width: 50px; height: 50px; min-width: 50px;">
                    ...
                    <div class="col-lg-6">
                        <div class="p-4 ht-monogram-card rounded-3 border-start border-success border-5 h-100">
                            ...
                            <p class="ht-monogram-text text-justify mb-0">
                                আজকে পৃথিবীময় ইসলামের নামে যে ধর্মটি চালু আছে সেটা আল্লাহর রসুলের প্রকৃত ইসলাম নয়, স্বভাবতই মুসলমান নামক যে জাতিটি রয়েছে তারাও প্রকৃত মুসলিম নয়। আল্লাহ রসুলের প্রকৃত আদর্শ থেকে তারা বহু দূরে সরে গেছে। কীভাবে দীর্ঘ ১৩শ বছরের কাল পরিক্রমায় আল্লাহ-রসুলের প্রকৃত ইসলাম বিকৃত হয়ে বিস্মৃতির অতল গহ্বরে হারিয়ে গেল সেই জ্ঞান এবং প্রকৃত ইসলামের জ্ঞান আল্লাহ মহামান্য এমামুয্যামানকে দান করেছেন। তিনি সেই প্রকৃত ইসলামের জ্ঞানকে মানুষের মাঝে ছড়িয়ে দেওয়ার জন্য হেযবুত তওহীদ আন্দোলনটি প্রতিষ্ঠা করেছেন। কাজেই হেযবুত তওহীদ প্রচলিত বিকৃত ইসলামকে বয়কট করেছে, সকল অন্যায় ও বিকৃতি থেকে হেজরত করেছে। তাই হেযবুত তওহীদ নিজেই মিথ্যাকে প্রত্যাখ্যান তথা হেজরতের প্রতীক।
                            </p>
                        </div>
                    </div>
