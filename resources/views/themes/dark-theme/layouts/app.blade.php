...
<head>
    ...
    <!-- Favicon -->
    <link rel="icon" type="image/png" href="{{ asset($setting->getSetting('favicon', 'themes/dark-theme/images/favicon.png')) }}">
    ...
    <!-- Custom CSS -->
    <link rel="stylesheet" href="{{ asset('themes/dark-theme/css/style.css') }}">
...
<body>
    ...
    <!-- Theme Custom JS -->
    <script src="{{ asset('themes/dark-theme/js/main.js') }}"></script>
