...
@section('title', 'ঘোষণাসমূহ ও বিবৃতি - হেজবুত তওহীদ')

@section('content')

    @include('theme::partials.hero_banner', [
        'title' => 'ঘোষণা ও বিবৃতি',
        'subtitle' => 'হেযবুত তওহীদের নীতিগত অবস্থান, বিবৃতি ও বিভিন্ন গুরুত্বপূর্ণ ঘোষণাসমূহ',
        'badge_text' => 'গুরুত্বপূর্ণ অফিশিয়াল বিবৃতি',
                    ...
                    <div class="row g-4">
                        ...
                        @empty
                            <div class="col-12 text-center py-5 bg-white rounded-4 shadow-sm border border-light">
                                ...
                                <h4 class="text-dark fw-bold" style="font-family: 'Baloo Da 2', sans-serif;">দুঃখিত, কোনো ঘোষণা বা বিবৃতি খুঁজে পাওয়া যায়নি!</h4>
                                <p class="text-secondary small">বর্তমানে কোনো ঘোষণা বা বিবৃতি প্রকাশ করা হয়নি।</p>
                            </div>
                        @endforelse
                    </div>
