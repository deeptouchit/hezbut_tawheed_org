    ...
    <div class="py-5 text-white position-relative" 
        ...
        <div class="container text-center py-2">
            <h1 class="fw-bold mb-2 text-white" style="font-family: 'Baloo Da 2', sans-serif; font-size: 2.2rem;">
                <i class="fas fa-folder-open me-2" style="color: #34D399;"></i> {{ $category->name }}
            </h1>
            <p class="lead small mb-0 opacity-90 text-white" style="font-family: 'Baloo Da 2', sans-serif; font-size: 1.05rem;">
                ক্যাটাগরি: {{ $category->name }} এর অধীনে প্রকাশিত সকল নিবন্ধ ও প্রকাশনাসমূহ
            </p>
        </div>
    </div>
                ...
                <div class="col-lg-8">
                    ...
                    <div class="bg-white p-3 rounded-3 shadow-sm border border-light-grey mb-4 d-flex justify-content-between align-items-center" style="font-family: 'Baloo Da 2', sans-serif; font-size: 0.92rem;">
                        <span class="text-secondary">
                            বর্তমানে প্রদর্শিত হচ্ছে ক্যাটাগরি: <strong class="text-success">"{{ $category->name }}"</strong> এর নিবন্ধসমূহ
                        </span>
                    ...
                    <div class="row g-4">
                        ...
                        @empty
                            <div class="col-12 text-center py-5 bg-white rounded-4 shadow-sm border border-light">
                                ...
                                <h4 class="text-dark fw-bold" style="font-family: 'Baloo Da 2', sans-serif;">দুঃখিত, এই ক্যাটাগরিতে কোনো নিবন্ধ পাওয়া যায়নি!</h4>
                                <p class="text-secondary small">অনুগ্রহ করে পরবর্তীতে আবার চেষ্টা করুন বা অন্যান্য ক্যাটাগরির নিবন্ধসমূহ ব্রাউজ করুন।</p>
