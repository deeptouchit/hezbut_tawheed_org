    ...
    <div class="reader-container" id="reader-container">
        ...
        <aside class="reader-sidebar" id="reader-sidebar">
            <div class="sidebar-header">
                <h6 class="fw-bold mb-0" style="font-family: 'Baloo Da 2', sans-serif; color: #006a4e;"><i
                        class="fas fa-university me-1"></i> লাইব্রেরী সূচী</h6>
                ...
                <a href="{{ route('books.read', $book->slug) }}" class="sidebar-book-item active">
                    ...
                    <div style="flex-grow: 1; overflow: hidden;">
                        ...
                        <div class="text-muted small" style="font-size: 11px;">
                            {{ Str::limit($book->writer ?? 'হেযবুত তওহীদ', 30) }}</div>
                    </div>
                </a>
                ...
                @foreach ($otherBooks as $ob)
                    <a href="{{ route('books.read', $ob->slug) }}" class="sidebar-book-item">
                        ...
                        <div style="flex-grow: 1; overflow: hidden;">
                            ...
                            <div class="text-muted small" style="font-size: 11px;">
                                {{ Str::limit($ob->writer ?? 'হেযবুত তওহীদ', 30) }}</div>
                        </div>
                    </a>
                @endforeach
            </div>
        ...
        <main class="reader-viewport">
            ...
            <div class="reader-controls">
                ...
                <!-- Book Title -->
                <div class="text-truncate fw-bold d-none d-md-block"
                    style="max-width: 450px; font-family: 'Baloo Da 2', sans-serif; font-size: 1.15rem; color: #006a4e;"
            ...
            <div class="pdf-viewer-container">
                @if ($book->pdf_url)
                    <!-- Desktop Iframe View -->
                    <iframe src="{{ asset($book->pdf_url) }}#toolbar=1&navpanes=0&scrollbar=1&page=1" width="100%"
                        height="100%" class="pdf-desktop-iframe" style="border: none; background: #525659;"></iframe>

                    <!-- Mobile View CTA -->
                    <div class="mobile-reader-cta">
                        <i class="fas fa-file-pdf"></i>
                        <h4 class="fw-bold mb-3" style="font-family: 'Baloo Da 2', sans-serif;">{{ $book->title }}</h4>
                        <p class="text-muted mb-4 small px-4">মোবাইল স্ক্রিনে স্বাচ্ছন্দ্যে পড়ার জন্য নিচের লিংকে ক্লিক করে
                            সরাসরি পিডিএফ সংস্করণটি ওপেন করুন।</p>
                        <a href="{{ asset($book->pdf_url) }}" target="_blank"
                            class="btn btn-control btn-gold btn-lg px-5 py-3 rounded-pill fw-bold fs-6">
                ...
                @else
                    ...
                    <div
                        style="padding: 3rem; overflow-y: auto; height: 100%; color: #0f172a; font-family: 'SolaimanLipi', serif; line-height: 1.8; font-size: 1.2rem; background: #ffffff;">
