...
<style>
    ...
    .vision-tab-btn.active {
        background: #f0fdf4; /* Soft Green Active Background */
        color: #006A4E; /* Deep Green Active Text */
        border-left-color: #006A4E; /* Vibrant Green left bar */
        font-weight: 700;
    }
