            ...
            <div class="bg-white rounded-4 p-4 p-md-5 shadow-sm border mb-5">
                <div class="row align-items-center">
                    <div class="col-lg-5 text-center mb-4 mb-lg-0">
                        <div class="hover-zoom d-inline-flex align-items-center justify-content-center bg-light p-4 rounded-4 shadow-sm border animate-hover" style="border-color: #cbd5e1 !important; transition: all 0.3s ease;">
                        ...
                        <div class="mt-4 text-center d-flex flex-column align-items-center justify-content-center w-100">
                            <h4 class="fw-bold mb-1" style="font-family: var(--font-bengali); color: #006A4E !important; text-align: center !important; width: 100%;">অফিশিয়াল মনোগ্রাম</h4>
                            <p class="text-secondary small fw-semibold mb-0" style="text-align: center !important; width: 100%;">ঐক্য, শৃঙ্খলা ও সংগ্রামের প্রতীক</p>
                        </div>
                    </div>
                ...
                <div class="row g-4">
                    ...
                    <div class="col-lg-6">
                        <div class="family-member-card p-4 h-100 d-flex flex-column" style="border-left: 5px solid #006A4E !important;">
                            <div class="d-flex align-items-center justify-content-center p-3 rounded-4 mb-4 border" style="background: linear-gradient(145deg, #f0fdf4, #f8fafc); height: 180px; transition: all 0.3s ease; border-color: rgba(0, 106, 78, 0.1) !important;">
                                <img src="{{ url('uploads/pages/monogram_kaba.svg') }}" alt="১. কাবা" class="img-fluid" style="max-height: 140px; width: auto; object-fit: contain; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.05));" />
                            </div>
                    ...
                    <div class="col-lg-6">
                        <div class="family-member-card p-4 h-100 d-flex flex-column" style="border-left: 5px solid #D4AF37 !important;">
                            <div class="d-flex align-items-center justify-content-center p-3 rounded-4 mb-4 border" style="background: linear-gradient(145deg, #f0fdf4, #f8fafc); height: 180px; transition: all 0.3s ease; border-color: rgba(0, 106, 78, 0.1) !important;">
                                <img src="{{ url('uploads/pages/monogram_raoza.svg') }}" alt="২. রসুলাল্লাহর রওজা" class="img-fluid" style="max-height: 140px; width: auto; object-fit: contain; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.05));" />
                            </div>
                            <div class="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div class="col-lg-6">
                        <div class="family-member-card p-4 h-100 d-flex flex-column" style="border-left: 5px solid #006A4E !important;">
                            <div class="d-flex align-items-center justify-content-center p-3 rounded-4 mb-4 border" style="background: linear-gradient(145deg, #f0fdf4, #f8fafc); height: 180px; transition: all 0.3s ease; border-color: rgba(0, 106, 78, 0.1) !important;">
                                <img src="{{ url('uploads/pages/monogram_quran.svg') }}" alt="৩. পবিত্র কোর’আন" class="img-fluid" style="max-height: 140px; width: auto; object-fit: contain; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.05));" />
                            </div>
                            <div class="d-flex align-items-center gap-3 mb-3">
                            ...
                            <p class="text-secondary mb-0" style="line-height: 1.7; text-align: justify; font-size: 0.95rem;">
                                पवित्र কোর’আন যার উপর কোর’আনুল হাকিম কথাটি লিখিত রয়েছে। কোর’আন হল আল্লাহর হুকুমসমূহের সমষ্টি। এই দীনের যাবতীয় হুকুমের, বিধানের মূল ভিত্তি হল কেবল আল্লাহর হুকুম মান্য করার অঙ্গীকার তথা তওহীদ। এই হুকুমগুলোর আনুগত্য, নীতিগুলোর অনুসরণই হচ্ছে ইসলাম। এজন্য হেযবুত তওহীদের কর্মসূচির তৃতীয় ধারা হচ্ছে আনুগত্য আর প্রতীকের তৃতীয় বিষয়টি হচ্ছে কীসের আনুগত্য করতে হবে তার প্রতীক কোর’আন।
                            </p>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="family-member-card p-4 h-100 d-flex flex-column" style="border-left: 5px solid #D4AF37 !important;">
                            <div class="d-flex align-items-center justify-content-center p-3 rounded-4 mb-4 border" style="background: linear-gradient(145deg, #f0fdf4, #f8fafc); height: 180px; transition: all 0.3s ease; border-color: rgba(0, 106, 78, 0.1) !important;">
                                <img src="{{ url('uploads/pages/monogram_ht.svg') }}" alt="৪. হেযবুত তওহীদ" class="img-fluid" style="max-height: 140px; width: auto; object-fit: contain; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.05));" />
                            </div>
                            <div class="d-flex align-items-center gap-3 mb-3">
                    ...
                    <div class="col-lg-12">
                        <div class="family-member-card p-4 h-100 d-flex flex-column" style="border-left: 5px solid #006A4E !important;">
                            <div class="d-flex align-items-center justify-content-center p-3 rounded-4 mb-4 border" style="background: linear-gradient(145deg, #f0fdf4, #f8fafc); height: 180px; transition: all 0.3s ease; border-color: rgba(0, 106, 78, 0.1) !important;">
                                <img src="{{ url('uploads/pages/monogram_sword.svg') }}" alt="৫. তলোয়ার" class="img-fluid" style="max-height: 140px; width: auto; object-fit: contain; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.05));" />
                            </div>
                            <div class="d-flex align-items-center gap-3 mb-3">
