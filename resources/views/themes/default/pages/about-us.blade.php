        ...
        <div class="container">
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6 ps-lg-5">
                    <h3 class="section-title mb-3" style="color: #006A4E; font-weight: 700;"><i class="fas fa-eye text-success me-2"></i> এক নজরে হেযবুত তওহীদ</h3>
                ...
                <div class="col-lg-6">
                    <div class="card h-100 border-0 shadow-sm rounded-4 bg-white p-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8">
                                <span class="badge bg-success bg-opacity-10 text-success mb-2 px-3 py-1">প্রতিষ্ঠাতা</span>
                                <h4 class="fw-bold mb-1 text-dark">মোহাম্মদ বায়াজীদ খান পন্নী</h4>
                                <p class="text-muted small mb-2">প্রতিষ্ঠাতা এমামুয্যামান</p>
                ...
                <div class="col-lg-6">
                    <div class="card h-100 border-0 shadow-sm rounded-4 bg-white p-4">
                        <div class="row align-items-center">
                            ...
                            <div class="col-md-8">
                                <span class="badge bg-success bg-opacity-10 text-success mb-2 px-3 py-1">বর্তমান এমাম</span>
                                <h4 class="fw-bold mb-1 text-dark">হোসাইন মোহাম্মদ সেলিম</h4>
            ...
            <div class="row g-4 mb-5">
                <div class="col-lg-6">
                    <div class="card h-100 border-0 shadow-sm rounded-4 text-white p-4 p-md-5" style="background: linear-gradient(135deg, #0f172a 0%, #1e293b 100%);">
                        <h4 class="fw-bold text-success mb-3" style="font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-scroll me-2"></i> মূলনীতি</h4>
                        <p class="small text-white-50 mb-4">হেযবুত তওহীদের মূল ভিত্তি হচ্ছে সার্বিক মানবকল্যাণ ও সত্যের জন্য ঐক্যবদ্ধ প্রচেষ্টা:</p>
                ...
                <div class="col-lg-6">
                    <div class="card h-100 border-0 shadow-sm rounded-4 text-white p-4 p-md-5" style="background: linear-gradient(135deg, #004b37 0%, #002d21 100%);">
                        ...
                        <p class="small text-white-50 mb-4">দীনুল হক বা ন্যায় প্রতিষ্ঠার লক্ষ্যে হেযবুত তওহীদ নিম্নোক্ত ৫ দফা কর্মসূচি পরিচালনা করে:</p>
            ...
            <div class="row align-items-center mb-5 pt-4">
                ...
                <div class="col-lg-6 ps-lg-5">
                    <h3 class="fw-bold mb-3" style="color: #006A4E; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-cogs me-2"></i> কর্মপ্রক্রিয়া</h3>
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6 pe-lg-5 order-lg-1">
                    <h3 class="fw-bold mb-3" style="color: #006A4E; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-dumbbell me-2"></i> প্রশিক্ষণ ও জীবনধারা</h3>
                    <p class="text-secondary leading-relaxed" style="line-height: 1.8;">
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6 ps-lg-5">
                    <h3 class="fw-bold mb-3" style="color: #006A4E; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-users-cog me-2"></i> সকল কাজে নারীদের অংশগ্রহণ</h3>
                    <p class="text-secondary leading-relaxed" style="line-height: 1.8;">
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6 pe-lg-5 order-lg-1">
                    <h3 class="fw-bold mb-3" style="color: #006A4E; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-music me-2"></i> সুস্থ ধারার সাংস্কৃতিক কর্মকাণ্ড</h3>
                    <p class="text-secondary leading-relaxed" style="line-height: 1.8;">
            ...
            <div class="row align-items-center mb-5">
                ...
                <div class="col-lg-6 ps-lg-5">
                    <h3 class="fw-bold mb-3" style="color: #006A4E; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-running me-2"></i> শরীরচর্চা ও খেলাধুলা</h3>
                    <p class="text-secondary leading-relaxed" style="line-height: 1.8;">
            ...
            <!-- Managed Institutes -->
            <div class="card p-4 p-md-5 mb-5 border-0 shadow-sm bg-white rounded-4 text-center">
                <h3 class="mb-4 fw-bold" style="color: #006A4E; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-building me-2"></i> পরিচালিত প্রতিষ্ঠানসমূহ</h3>
                <div class="d-flex flex-wrap justify-content-center gap-3">
                    <span class="badge bg-success bg-opacity-10 text-success p-3 fs-6 rounded-pill border border-success border-opacity-25"><i class="fas fa-book-open me-1"></i> তওহীদ প্রকাশন</span>
                    <span class="badge bg-success bg-opacity-10 text-success p-3 fs-6 rounded-pill border border-success border-opacity-25"><i class="fas fa-users me-1"></i> তওহীদ কাবাডি দল</span>
                    <span class="badge bg-success bg-opacity-10 text-success p-3 fs-6 rounded-pill border border-success border-opacity-25"><i class="fas fa-newspaper me-1"></i> দৈনিক বজ্রশক্তি</span>
                    <span class="badge bg-success bg-opacity-10 text-success p-3 fs-6 rounded-pill border border-success border-opacity-25"><i class="fas fa-photo-video me-1"></i> ইলদ্রিম মিডিয়া</span>
                    <span class="badge bg-success bg-opacity-10 text-success p-3 fs-6 rounded-pill border border-success border-opacity-25"><i class="fas fa-globe me-1"></i> বাংলাদেশের পত্র (অনলাইন)</span>
                    <span class="badge bg-success bg-opacity-10 text-success p-3 fs-6 rounded-pill border border-success border-opacity-25"><i class="fas fa-tv me-1"></i> jatiyatv.com (অনলাইন)</span>
                </div>
            </div>

            <!-- Published Books -->
            <div class="card p-4 p-md-5 mb-5 border-0 shadow-sm bg-white rounded-4">
                <h3 class="mb-4 text-center fw-bold" style="color: #006A4E; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-book me-2"></i> প্রকাশিত পুস্তকসমূহ</h3>
                <div class="row g-3">
                    <div class="col-md-6 col-lg-4"><div class="p-3 border-start border-success border-4 bg-light rounded-3 shadow-sm fw-semibold"><i class="fas fa-check text-success me-2"></i> ইসলামের প্রকৃত রূপরেখা</div></div>
                    <div class="col-md-6 col-lg-4"><div class="p-3 border-start border-success border-4 bg-light rounded-3 shadow-sm fw-semibold"><i class="fas fa-check text-success me-2"></i> ইসলামের প্রকৃত সালাহ্</div></div>
                    <div class="col-md-6 col-lg-4"><div class="p-3 border-start border-success border-4 bg-light rounded-3 shadow-sm fw-semibold"><i class="fas fa-check text-success me-2"></i> দাজ্জাল? ইহুদি-খ্রিষ্টান ‘সভ্যতা’!</div></div>
                    <div class="col-md-6 col-lg-4"><div class="p-3 border-start border-success border-4 bg-light rounded-3 shadow-sm fw-semibold"><i class="fas fa-check text-success me-2"></i> The Lost Islam</div></div>
                    <div class="col-md-6 col-lg-4"><div class="p-3 border-start border-success border-4 bg-light rounded-3 shadow-sm fw-semibold"><i class="fas fa-check text-success me-2"></i> হেযবুত তওহীদের লক্ষ্য ও উদ্দেশ্য</div></div>
                    <div class="col-md-6 col-lg-4"><div class="p-3 border-start border-success border-4 bg-light rounded-3 shadow-sm fw-semibold"><i class="fas fa-check text-success me-2"></i> জেহাদ, কেতাল ও সন্ত্রাস</div></div>
                    <div class="col-md-6 col-lg-4"><div class="p-3 border-start border-success border-4 bg-light rounded-3 shadow-sm fw-semibold"><i class="fas fa-check text-success me-2"></i> আল্লাহর মো’জেজা: বিজয় ঘোষণা</div></div>
                    <div class="col-md-6 col-lg-4"><div class="p-3 border-start border-success border-4 bg-light rounded-3 shadow-sm fw-semibold"><i class="fas fa-check text-success me-2"></i> বর্তমানের বিকৃত সুফিবাদ</div></div>
                    <div class="col-md-6 col-lg-4"><div class="p-3 border-start border-success border-4 bg-light rounded-3 shadow-sm fw-semibold"><i class="fas fa-check text-success me-2"></i> ঔপনিবেশিক ষড়যন্ত্রমূলক শিক্ষাব্যবস্থা</div></div>
                </div>
            </div>

            <!-- Youtube Documentaries -->
            <div class="card p-4 p-md-5 mb-5 border-0 shadow-sm bg-white rounded-4">
                <h3 class="mb-4 text-center fw-bold" style="color: #006A4E; font-family: 'Baloo Da 2', sans-serif;"><i class="fab fa-youtube text-danger me-2"></i> উল্লেখযোগ্য প্রামাণ্যচিত্রসমূহ</h3>
                <div class="row g-4">
                    <div class="col-md-6 col-lg-4">
                        <div class="border rounded-3 overflow-hidden shadow-sm bg-light hover-lift">
                            <a href="https://www.youtube.com/watch?v=EMZgDNuyQEc" target="_blank" class="text-decoration-none">
                                ...
                                <div class="p-3 fw-bold text-dark text-center" style="font-size: 0.95rem;">এক জাতি এক দেশ, ঐক্যবদ্ধ বাংলাদেশ</div>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="border rounded-3 overflow-hidden shadow-sm bg-light hover-lift">
                            <a href="https://www.youtube.com/watch?v=NDfi55itQas" target="_blank" class="text-decoration-none">
                                ...
                                <div class="p-3 fw-bold text-dark text-center" style="font-size: 0.95rem;">ধর্মব্যবসা ও অপ-রাজনীতির ইতিবৃত্ত</div>
                            </a>
                        </div>
                    </div>
                    <div class="col-md-6 col-lg-4">
                        <div class="border rounded-3 overflow-hidden shadow-sm bg-light hover-lift">
                            <a href="https://www.youtube.com/watch?v=CkTYeo_Mprg" target="_blank" class="text-decoration-none">
                                ...
                                <div class="p-3 fw-bold text-dark text-center" style="font-size: 0.95rem;">ইসলামে নারীর প্রকৃত মর্যাদা</div>
                            </a>
                        </div>
                    </div>
                </div>
            ...
            @if(isset($teamMembers) && count($teamMembers) > 0)
                <div class="mt-5 pt-4">
                    <h3 class="mb-5 text-center fw-bold" style="color: #0f172a; font-size: 2rem; font-family: 'Baloo Da 2', sans-serif;"><i class="fas fa-users-cog me-2 text-success"></i> কেন্দ্রীয় কার্যনির্বাহী কমিটি</h3>
                    <div class="row g-4 justify-content-center">
                        @foreach($teamMembers as $member)
                            <div class="col-lg-3 col-md-4 col-sm-6 col-10">
                                <div class="card text-center border-0 shadow-sm rounded-4 overflow-hidden bg-white h-100 hover-lift" style="transition: all 0.3s ease;">
                                    ...
                                    <div class="card-body p-3 bg-white">
                                        <h5 class="fw-bold text-dark mb-1" style="font-size: 1.15rem; color: #0f172a !important;">{{ $member->name }}</h5>
