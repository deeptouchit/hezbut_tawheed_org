                        ...
                        <div class="player-wrapper mb-4">
                            ...
                            <div class="card border-0 shadow-lg rounded-4 overflow-hidden bg-black player-container-card" id="player-card" style="aspect-ratio: 16/9; position: relative;">
                                ...
                                <div class="audio-cover-art w-100 h-100 d-flex flex-column align-items-center justify-content-center bg-gradient-brand {{ $firstSong->youtube_id ? 'd-none' : '' }}" id="audioPlaybackArea">
                                    <div class="cover-music-circle d-flex align-items-center justify-content-center shadow-lg">
                                        <i class="fas fa-compact-disc text-success spin-cd" id="playerCdIcon" style="font-size: 3.5rem; color: #22c55e !important;"></i>
                                    </div>
                            ...
                            <div class="card border-0 shadow-sm rounded-4 mt-3 p-4 bg-white {{ $firstSong->youtube_id ? 'd-none' : '' }}" id="audioControlsWrapper">
                                ...
                                <div class="progress-container mb-3" id="audioProgressContainer">
                                    <div class="progress-bar-slider" id="progressWrapper" style="background-color: #e2e8f0 !important;">
                                        <div class="progress-fill" id="progressBarFill" style="background-color: #22c55e !important;"></div>
                                        <div class="progress-dot" id="progressHandle" style="border-color: #22c55e !important; box-shadow: 0 0 6px rgba(34, 197, 94, 0.4) !important;"></div>
                                    </div>
                                ...
                                <div class="d-flex align-items-center justify-content-between flex-wrap gap-3">
                                    <div class="d-flex align-items-center gap-3">
                                        ...
                                        <!-- Play/Pause -->
                                        <button class="btn-deck-control play-control" id="playBtn" title="প্লে/পজ" style="background-color: #22c55e !important; box-shadow: 0 4px 15px rgba(34, 197, 94, 0.25) !important;">
                            ...
                            <div class="card border-0 shadow-sm rounded-4 mt-3 p-4 bg-white">
                                <div class="d-flex justify-content-between align-items-start gap-2 mb-3">
                                    <div>
                                        <span class="badge rounded-pill px-3 py-1.5 fw-bold mb-2" id="categoryBadge" style="font-family: 'Baloo Da 2', sans-serif; font-size: 11px; background-color: rgba(34, 197, 94, 0.15); color: #22c55e; border: 1px solid rgba(34, 197, 94, 0.25);">
                                        ...
                                        <p class="text-success small mb-0 d-flex align-items-center gap-1.5" style="font-family: 'Baloo Da 2', sans-serif; color: #22c55e !important; font-weight: 600;">
                        ...
                        <div class="card border-0 shadow-sm rounded-4 p-3 bg-white sticky-sidebar-card">
                            <div class="d-flex align-items-center justify-content-between mb-3 pb-2 border-bottom">
                                <h5 class="fw-bold text-dark mb-0 d-flex align-items-center gap-2" style="font-family: 'Baloo Da 2', sans-serif; font-size: 1.05rem;">
                                    <span class="playlist-icon-wrap"><i class="fas fa-play-circle" style="color: #22c55e;"></i></span>
                                    গানের প্লেলিস্ট
                                </h5>
